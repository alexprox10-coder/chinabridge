    ...
    <div className="min-h-screen bg-slate-950 text-white pb-24 md:pb-0">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-slate-900/95 backdrop-blur border-t border-slate-700 px-4 py-3 flex gap-3">
        ...
        <a
          ...
          onClick={() => {
            trackGAEvent("contact", { method: "telegram_sticky", source: config.source });
            if (typeof window !== "undefined" && (window as any).VK) (window as any).VK.Goal("lead");
          }}
          className="flex-1 flex items-center justify-center gap-2 bg-[#229ED9] text-white font-bold py-3 rounded-xl text-sm"
        >
