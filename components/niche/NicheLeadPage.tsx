      ...
      <main className="max-w-5xl mx-auto px-4">
        ...
        <div className="md:hidden pt-6 pb-8">
          ...
          <div className="flex flex-col gap-3 mb-6">
            <a
              href="tel:+79145889874"
              onClick={() => trackContact("phone_hero", config.source)}
              className="flex items-center justify-center gap-2.5 bg-red-600 text-white font-bold py-4 rounded-2xl text-base shadow-lg shadow-red-600/20"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 shrink-0"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/></svg>
              Позвонить — ответим сразу
            </a>
            <a
              href={tgHref}
              target="_blank"
