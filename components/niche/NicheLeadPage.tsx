            ...
            {state === "done" ? (
              ...
              <>
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1db954] text-white font-semibold py-3 rounded-xl transition text-sm mb-4"
                >
                  ...
                  Написать в WhatsApp — ответим за 5 мин
                </a>
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                  <input
                    ...
                    className="bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#229ED9] transition"
                  />
                  <input
                    type="text"
                    placeholder="WhatsApp +7 999..."
                    value={form.whatsapp}
                    onChange={set("whatsapp")}
                    className="bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#25D366] transition"
                  />
                </div>
