...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Выкупаем товар, оформляем белую таможню через Суньфэньхэ — выдаём ГТД с номером для листинга на WB и Ozon, доставляем до склада",
  },
  {
    n: "05",
    icon: "💰",
    title: "Ваша прибыль",
    desc: "Товар с полным пакетом: ГТД, сертификаты качества, тех. паспорта — прямые цены производителя, карточки не блокируются",
  },
];
