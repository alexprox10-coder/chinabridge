...
const advantages = [
  ...
  },
  {
    icon: Package,
    title: "Сборные грузы",
    desc: "КЗ — от 30 кг, Россия через Хэйхэ — от 100 кг. Еженедельные рейсы — не ждёте полного контейнера.",
  ...
  },
  {
    ...
    desc: "Выдаём ГТД с номером для листинга на WB и Ozon. Сертификаты качества и тех. паспорта прилагаются по запросу.",
