...
const checks = [
  ...
  "Казахстан: от 10 дней · Россия: от 18 дней · груз застрахован",
];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            {/* Quick contacts */}
            <div className="fade-up flex flex-wrap items-center gap-3 mt-6">
              ...
              <a href="https://wa.me/79145889874?text=Здравствуйте%2C%20хочу%20узнать%20о%20доставке%20из%20Китая" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#25D366]/15 border border-[#25D366]/40 text-[#25D366] font-semibold text-sm hover:bg-[#25D366]/25 hover:border-[#25D366]/70 transition-all">
