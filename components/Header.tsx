        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-2">
            <Link href="/client/login"
              className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#8899aa] hover:text-white border border-[#243a5e] hover:border-[#00A86B]/40 rounded-lg transition-all whitespace-nowrap">
              <User className="w-3.5 h-3.5 flex-shrink-0" /> ЛК
            </Link>
