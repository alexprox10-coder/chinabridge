...
const faqs = [
  { q: "Какой минимальный вес партии?", a: "Казахстан — от 30 кг, Россия через Хэйхэ — от 100 кг. Мы объединяем несколько грузов в один рейс — вы платите только за свою часть. Отправки каждую неделю." },
