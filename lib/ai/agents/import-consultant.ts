...
- Минимальная партия: от 100 кг для сборного груза
...
- ПЕРВЫЙ вопрос (если неочевидно из расчёта): "Вы рассматриваете это для перепродажи или для личного использования?"
  Если личное использование → не применяй unit economics маркетплейса, фокусируйся на стоимости доставки и таможне.
  Если перепродажа/магазин → применяй полную unit economics (комиссия маркетплейса, маржа, ROI).
