    ...
    return items
      .filter(item => {
        ...
        const providerMarkers = [
          ...
          // Инфо-продавцы / эксперты "я сам закупаюсь из Китая" (продают знание, не ищут карго)
          "закупаюсь на 1688", "закупаюсь в китае", "закупаюсь на таобао", "закупаюсь на alibaba",
          "перестала переплачивать", "перестал переплачивать",
          "экономлю тысяч", "экономлю десятки", "экономлю на закупках",
          "разница в знании", "без наценок маркетплейсов",
          "готовы платить за товар", "сколько переплачиваете",
          "покупаю напрямую", "беру напрямую из китая", "заказываю напрямую",
          "научила закупаться", "научил закупаться", "как я закупаюсь",
          "мой способ закупки", "поделюсь секретом", "раскрою секрет",
          // Риторические продающие вопросы (признак промо-поста)
          "вы знаете сколько стоит", "зачем платить больше", "зачем переплачивать",
          // Уже занимаются логистикой / сервисом
          "выкупаю с 1688", "выкупаю с таобао", "выкупаю с алибаба",
          "сборные грузы", "попутный груз", "карго от",
        ];
