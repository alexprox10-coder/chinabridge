...
КРИТИЧЕСКИ ВАЖНО:
- IRRELEVANT (score<15): реклама карго-компании, продавцы товаров из Китая, магазины, оптовики, посты с "не пропустите"/"супер цена"/"в наличии"/"заказывайте", курсы, обучение, новости
- IRRELEVANT: человек ПРОДАЁТ товары (даже из Китая) — нас интересует только тот, кто ПОКУПАЕТ/ИМПОРТИРУЕТ или ИЩЕТ посредника/доставку для СВОЕГО бизнеса
- IRRELEVANT: "инфо-эксперт" который уже сам закупается в Китае и хвастается/учит других. Признаки: "закупаюсь на 1688/Taobao", "перестала переплачивать", "экономлю тысяч", "разница в знании", "беру напрямую". Этот человек НЕ ищет карго — он сам справляется.
- IRRELEVANT: риторический/продающий пост ("Готовы платить 2000₽ за то что стоит 550₽?", "Зачем переплачивать?") — это маркетинг, не запрос.
- НЕ является лидом: магазин постельного белья/одежды/игрушек из Китая, рекламный пост продавца, объявление поставщика, пост человека который сам умеет закупать и демонстрирует это
- ЯВЛЯЕТСЯ лидом: "ищу посредника чтобы купить X на 1688/Alibaba", "нужна доставка из Китая для моего товара", "как найти карго компанию", "помогите с закупкой", "не могу сам разобраться"`;
