...
- НЕ является лидом: магазин постельного белья/одежды/игрушек из Китая, рекламный пост продавца, объявление поставщика
- ЯВЛЯЕТСЯ лидом: "ищу посредника чтобы купить X на 1688/Alibaba", "нужна доставка из Китая для моего товара", "как найти карго компанию"`;
