...
console.log("Creating outbound_leads table...");
...
await sql`CREATE INDEX IF NOT EXISTS outbound_leads_tenant_idx ON outbound_leads (tenant_id)`;
await sql`CREATE INDEX IF NOT EXISTS outbound_leads_stage_idx ON outbound_leads (stage)`;
await sql`CREATE INDEX IF NOT EXISTS outbound_leads_country_idx ON outbound_leads (country)`;
await sql`CREATE INDEX IF NOT EXISTS outbound_leads_vertical_idx ON outbound_leads (vertical)`;
await sql`CREATE INDEX IF NOT EXISTS outbound_leads_dedup_idx ON outbound_leads (dedup_hash)`;
