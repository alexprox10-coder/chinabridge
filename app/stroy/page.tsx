...
export const metadata: Metadata = {
  ...
  description: "Стройматериалы из Китая оптом: плитка, арматура, сантехника, опалубка, фасадные панели. Доставка в Россию и Казахстан. от 100 кг или полный контейнер.",
...
export default function Page() {
  return (
    <NicheLeadPage config={{
      ...
      subtitle: "Плитка, арматура, сантехника, опалубка — сборным грузом (от 100 кг) или полным контейнером.",
      product_placeholder: "Плитка, арматура, сантехника...",
      source: "niche_construction",
      benefits: [
        "Сборные грузы от 100 кг — не нужно ждать полного контейнера",
