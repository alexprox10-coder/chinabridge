...
const PLANS = [
  {
    ...
    features: [
      "5 расчётов AI-калькулятора маржи",
    ...
    limits: ["Лимит 5 расчётов (AI-калькулятор маржи)", "Без истории расчётов"],
  ...
  },
  {
    ...
    features: [
      ...
      "Первые 10 расчётов — бесплатно при регистрации",
      "Всё из тарифа Гость",
  ...
  },
  {
    ...
    features: [
      ...
      "Всё из тарифа PRO",
      "Реальные ставки карго: KZ от $2.50/кг, RU от $3.00/кг",
      "Менеджер проверит расчёт и найдёт товар",
      "Полный цикл: закупка → доставка → таможня (18–22 дня авто / 3–8 дней авиа)",
    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-2">
          * Конкуренты (MPStats, Moneyplace, MarketGuru, Sellmonitor) — платформы аналитики рынка, от 3 000 до 15 000 ₽/мес. Чистые калькуляторы юнит-экономики (Wildbox, logidex) — бесплатные.
        </p>
      </div>
