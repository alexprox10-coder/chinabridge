...
async function queryLeads(sql: any, stage: string, country: string, vertical: string, limit: number): Promise<Record<string, any>[]> {
  if (stage && country && vertical) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE stage=${stage} AND country=${country} AND vertical=${vertical} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (stage && country) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE stage=${stage} AND country=${country} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (stage && vertical) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE stage=${stage} AND vertical=${vertical} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (stage) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE stage=${stage} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (country && vertical) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE country=${country} AND vertical=${vertical} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (country) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE country=${country} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else if (vertical) {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads WHERE vertical=${vertical} ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  } else {
    return sql`SELECT outbound_id,company_name,city,country,category,marketplace,phone,email,website,stage,source,vertical,opportunity_score,company_score,lead_score,COALESCE(evidence_score,0)AS evidence_score,reason_to_contact,personalized_message,message_quality_score,response_status,pitch_type,china_match_status,COALESCE(recommended_offer,'')AS recommended_offer,COALESCE(next_best_action,'')AS next_best_action,COALESCE(lead_quality,'UNREVIEWED')AS lead_quality,china_match,products,economics,COALESCE(evidence_data,'{}')AS evidence_data,created_at,COALESCE(company_id,'')AS company_id,COALESCE(china_source_url,'')AS china_source_url,COALESCE(china_unit_price,NULL)AS china_unit_price,COALESCE(local_selling_price,NULL)AS local_selling_price,COALESCE(data_quality_score,0)AS data_quality_score,COALESCE(raw_opportunity_score,0)AS raw_opportunity_score,COALESCE(country_verified,false)AS country_verified,COALESCE(company_verified,false)AS company_verified,COALESCE(product_verified,false)AS product_verified,COALESCE(contact_verified,false)AS contact_verified,COALESCE(source_verified,false)AS source_verified,COALESCE(message_status,'DRAFT')AS message_status,COALESCE(approval_status,'PENDING')AS approval_status,COALESCE(outreach_status,'NOT_SENT')AS outreach_status,COALESCE(message_version,'v1')AS message_version,COALESCE(quote_id,'')AS quote_id,COALESCE(deal_id,'')AS deal_id FROM outbound_leads ORDER BY opportunity_score DESC LIMIT ${limit}` as Promise<Record<string,any>[]>;
  }
}
