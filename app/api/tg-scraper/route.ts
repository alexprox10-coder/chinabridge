...
const HOT_KEYWORDS = [
  ...
  "поставщик из китая", "нужен поставщик", "1688", "алибаба", "alibaba",
  "растаможка", "таможня", "карго из китая", "везу из китая", "закупка китай",
  "доставка товара из китая", "фулфилмент", "wb поставщик", "ozon поставщик",
  "маркетплейс китай", "байер китай", "закупщик китай", "выкуп на 1688",
  "выкуп alibaba", "ищу поставщика", "нужен байер", "посредник китай",
  "отправка из китая", "карго служба", "логистика китай", "cargo china",
];
