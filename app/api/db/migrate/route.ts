...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    `);
    await sql.unsafe(`CREATE INDEX IF NOT EXISTS "outbound_leads_tenant_idx" ON "outbound_leads" ("tenant_id")`);
    await sql.unsafe(`CREATE INDEX IF NOT EXISTS "outbound_leads_stage_idx" ON "outbound_leads" ("stage")`);
    await sql.unsafe(`CREATE INDEX IF NOT EXISTS "outbound_leads_country_idx" ON "outbound_leads" ("country")`);
    await sql.unsafe(`CREATE INDEX IF NOT EXISTS "outbound_leads_vertical_idx" ON "outbound_leads" ("vertical")`);
    await sql.unsafe(`CREATE INDEX IF NOT EXISTS "outbound_leads_dedup_idx" ON "outbound_leads" ("dedup_hash")`);
    results.push("OK: outbound_leads");
  } catch (err: unknown) {
