...
export const metadata: Metadata = {
  ...
  description: "Одежда и текстиль из Китая оптом в Россию и Казахстан. Найдём фабрику под ваш бренд, согласуем образцы. КЗ от 30 кг · РФ от 100 кг, поставки под WB, Ozon и Kaspi.",
...
export default function Page() {
  return (
    <NicheLeadPage config={{
      ...
      subtitle: "Найдём фабрику под ваш бренд или готовый товар. КЗ от 30 кг, Россия от 100 кг — не нужен полный контейнер.",
      ...
      "Сборный груз: КЗ от 30 кг, Россия от 100 кг — без предоплаты контейнера",
