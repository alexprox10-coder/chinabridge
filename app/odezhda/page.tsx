...
export const metadata: Metadata = {
  ...
  description: "Одежда и текстиль из Китая оптом в Россию и Казахстан. Найдём фабрику под ваш бренд, согласуем образцы. от 100 кг, поставки под WB, Ozon и Kaspi.",
...
export default function Page() {
  return (
    <NicheLeadPage config={{
      ...
      subtitle: "Найдём фабрику под ваш бренд или готовый товар. От 100 кг — не нужен полный контейнер.",
      ...
      "Сборный груз от 100 кг — без предоплаты контейнера",
