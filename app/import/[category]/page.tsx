...
const CATEGORIES: Record<string, {
  ...
  electronics: {
    ...
    emoji: "📱",
    priceHint: "от $3.0/кг авто 12-16 дн · авиа от $23/кг · море от $1.1/кг · Россия от 100 кг · КЗ от 30 кг",
  ...
  clothing: {
    ...
    subtitle: "Оптовые поставки одежды с фабрик Гуанчжоу, Чэнду и Иу. КЗ от 30 кг · Россия от 100 кг. Маркировка Честный Знак под ключ.",
      ...
      <main className="max-w-lg mx-auto px-4 py-8 sm:py-14 pb-28 sm:pb-14">
        ...
        <div className="flex flex-col gap-3 mb-8">
          {[
            ...
            { icon: "📦", title: "Небольшая партия?", desc: "КЗ от 30 кг, Россия от 100 кг, сборные рейсы." },
