...
const CATEGORIES: Record<string, {
  ...
  electronics: {
    ...
    emoji: "📱",
    priceHint: "от $1.1/кг морем · от $2/кг авто · от $2.5/кг авиа · сборный груз",
  ...
  "auto-parts": {
    ...
    emoji: "🚗",
    priceHint: "от $0.9/кг морем · от $2/кг авто · от $2.2/кг авиа · сборный груз",
  ...
  clothing: {
    ...
    emoji: "👕",
    priceHint: "от $0.85/кг морем · от $2/кг авто · от $2.3/кг авиа · сборный груз",
  ...
  furniture: {
    ...
    emoji: "🛋️",
    priceHint: "от $110/м³ морем · авто от $2/кг · от $180/м³ FCL · сборный груз",
  ...
  equipment: {
    ...
    emoji: "⚙️",
    priceHint: "от $1.2/кг морем · от $2/кг авто · FCL от $850 · сборный груз",
  ...
  lighting: {
    ...
    emoji: "💡",
    priceHint: "от $1.0/кг морем · от $2/кг авто · от $2.4/кг авиа · сборный груз",
  ...
  components: {
    ...
    emoji: "🔩",
    priceHint: "авто от $2/кг · авиа от $3/кг · авиаэкспресс от $5/кг · сборный груз",
