...
const CATEGORIES: Record<string, {
  ...
  electronics: {
    ...
    emoji: "📱",
    priceHint: "от $3.0/кг авто 12-16 дн · авиа от $23/кг · море от $1.1/кг · от 100 кг",
  ...
  clothing: {
    ...
    subtitle: "Оптовые поставки одежды с фабрик Гуанчжоу, Чэнду и Иу. От 100 кг. Маркировка Честный Знак под ключ.",
      ...
      <main className="max-w-lg mx-auto px-4 py-8 sm:py-14 pb-28 sm:pb-14">
        ...
        <div className="flex flex-col gap-3 mb-8">
          {[
            ...
            { icon: "📦", title: "Небольшая партия?", desc: "от 100 кг, сборные рейсы." },
