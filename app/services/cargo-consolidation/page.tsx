...
export const metadata: Metadata = {
  title: "Сборные грузы из Китая — консолидация | ChinaBridge",
  description: "Сборные грузы из Китая в Россию: объединяем несколько заказов в одну отправку. Экономия на доставке до 40% vs индивидуальные отправки.",
...
const schema = {
  ...
  description: "Консолидация и доставка сборных грузов из Китая в Россию и Казахстан.",
  areaServed: "RU",
...
const FAQ = [
  ...
  },
  {
    ...
    answer: "Минимум зависит от маршрута. Для Казахстана — от 30 кг, для России через Хэйхэ (ТПТ) — от 100 кг. При меньших объёмах предлагаем авиадоставку или консолидацию с другими клиентами.",
  },
  {
    ...
    <main className="min-h-screen bg-[#0B1F3A] text-white">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <p className="text-[#8899aa] text-lg max-w-2xl mb-8">
          ...
          Минимум: Казахстан от 30 кг, Россия через Хэйхэ от 100 кг.
        </p>
        <Link
          href="/#calculator"
