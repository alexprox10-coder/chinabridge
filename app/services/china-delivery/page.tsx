...
export const metadata: Metadata = {
  ...
  description: "Доставка грузов из Китая в Россию: маршрут через Хэйхэ от 100 кг, контейнеры, авиа. Официальное таможенное оформление. Рассчитайте стоимость онлайн.",
  ...
  openGraph: {
    title: "Доставка из Китая в Россию — ChinaBridge",
    description: "Маршрут через Хэйхэ — Благовещенск от 100 кг, контейнеры, авиа. Официальная таможня. Рассчитайте онлайн.",
...
const FAQ = [
  ...
  },
  {
    ...
    answer: "Зависит от маршрута. Через Хэйхэ — Благовещенск (ТПТ): от 100 кг. Казахстан: от 30 кг. Авиа: от 1 кг. Рассчитайте оптимальный маршрут через калькулятор.",
  },
  {
