...
export const metadata: Metadata = {
  ...
  description:
    "Карго и сборные грузы из Китая в Алматы. Авто 18–22 дня, авиа 5–8 дней. Представитель в Китае, работаем с Kaspi.kz. Расчёт за 15 минут.",
  keywords: [
  ...
  openGraph: {
    title: "Карго из Китая в Алматы — доставка от 50 кг | ChinaBridge",
    description: "Карго из Китая в Алматы: авто 18–22 дня, авиа 5–8 дней. Представитель в Китае.",
    type: "article",
    url: CANONICAL,
    locale: "ru_RU",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Стоимость карго из Китая в Алматы — от $2.50/кг при авто-доставке (18–22 дня). Авиадоставка от $23/кг (5–8 дней). Минимальная партия — 50 кг.",
          },
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Автодоставка из Китая в Алматы занимает 18–22 дня. Авиадоставка — 5–8 дней.",
          },
        },
        {
          "@type": "Question",
...
const RATES = [
  { type: "Автодоставка", time: "18–22 дня", price: "от $2.50/кг", min: "50 кг", note: "Самый популярный маршрут" },
            ...
            {[
              {
                ...
                a: "Автодоставка от $2.50/кг (18–22 дня), авиа от $23/кг (5–8 дней). Финальная цена зависит от объёма и плотности груза.",
              },
              {
