...
export const metadata: Metadata = {
  ...
  description:
    "Карго и сборные грузы из Китая в Астану. Авто 18–22 дня, авиа 5–8 дней. Выкуп у поставщика, представитель в Китае. Расчёт за 15 минут.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Карго из Китая в Астану: авто 18–22 дня, авиа 5–8 дней. Представитель в Китае.",
    type: "article",
    url: CANONICAL,
    locale: "ru_RU",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Стоимость карго из Китая в Астану — от $2.50/кг при авто-доставке (18–22 дня). Авиадоставка от $23/кг (5–8 дней). Минимальная партия — 50 кг.",
          },
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Автодоставка из Китая в Астану занимает 18–22 дня. Авиадоставка — 5–8 дней.",
          },
        },
      ],
    },
...
const RATES = [
  { type: "Автодоставка", time: "18–22 дня", price: "от $2.50/кг", min: "50 кг", note: "Оптимально для крупных партий" },
  { type: "Авиадоставка", time: "5–8 дней",  price: "от $23/кг",  min: "1 кг",  note: "Срочные и лёгкие грузы" },
];
            ...
            {[
              {
                ...
                a: "Автодоставка от $2.50/кг (18–22 дня), авиа от $23/кг (5–8 дней). Итоговая цена зависит от объёма и плотности груза.",
              },
              {
