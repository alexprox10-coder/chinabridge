...
const AI_MODULES = [
  ...
  { id: "sales",     icon: "💼", label: "Продажи AI" },
  { id: "marketing", icon: "📢", label: "Маркетинг AI" },
  { id: "content",   icon: "✍️", label: "Контент AI" },
  { id: "analytics", icon: "📊", label: "Аналитика AI" },
  { id: "operations",icon: "⚙️", label: "Операции AI" },
  { id: "finance",   icon: "💰", label: "Финансы AI" },
  { id: "strategy",  icon: "🎯", label: "Стратегия AI" },
  { id: "ceo",       icon: "👑", label: "Командный центр CEO AI" },
