...
export const metadata: Metadata = {
  title: "AI-инструменты для импорта из Китая | ChinaBridge",
...
const tools = [
  {
    ...
    tags: ["OCR · ZH→RU", "Расчёт доставки", "AI"],
    badge: "Новое",
  },
  {
    href: "/ai-calculator",
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px" }}>
        <div style={{ marginBottom: "40px" }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: "16px" }}>
            AI-инструменты для работы с китайскими поставщиками и расчёта доставки.
          </p>
        </div>
