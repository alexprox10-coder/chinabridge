    ...
    <main>
      ...
      <div className="relative min-h-screen bg-[#060f1e] pt-16 sm:pt-24 pb-24 sm:pb-24">
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6">
          ...
          {/* ── MOBILE QUICK CONTACTS — compact row above funnel ── */}
          <div className="sm:hidden mb-4 flex gap-2">
            <a
              href="https://t.me/ChinaBridgeLID_bot"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 bg-[#229ED9]/10 border border-[#229ED9]/30 hover:bg-[#229ED9]/20 text-[#229ED9] font-medium rounded-xl text-xs transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 bg-[#25D366]/10 border border-[#25D366]/30 hover:bg-[#25D366]/20 text-[#25D366] font-medium rounded-xl text-xs transition-colors"
            >
