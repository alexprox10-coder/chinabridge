    ...
    <main>
      ...
      <div className="relative min-h-screen bg-[#060f1e] pt-16 sm:pt-24 pb-24 sm:pb-24">
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6">
          ...
          {/* ── MOBILE QUICK CONTACT — compact secondary link above funnel ── */}
          {/* TODO: add tel: href and WhatsApp when 8800 number is connected */}
          <div className="sm:hidden mb-4 text-center">
            <a
              href="https://t.me/ChinaBridgeLID_bot"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-xs text-[#8899aa] hover:text-[#229ED9] transition-colors"
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 text-[#229ED9]">
