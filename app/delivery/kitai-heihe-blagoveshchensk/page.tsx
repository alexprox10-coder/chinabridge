...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Зависит от города отправки и пункта назначения в России. Переход Хэйхэ — Благовещенск — 3 дня. Дополнительно: время таможенного оформления и доставка по России.",
  },
];
          ...
          {[
            {
              ...
              desc: "Алматы, Астана, Шымкент. Авто от 100 кг, авиа от 1 кг.",
              flag: "🇰🇿",
            },
            {
