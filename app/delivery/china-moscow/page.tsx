...
export const metadata: Metadata = {
  ...
  description: "Доставка грузов из Китая в Москву: сборные грузы, контейнеры, авиа. Маршрут через Хэйхэ — Благовещенск от 100 кг. Срок 18–45 дней. Таможня.",
  ...
  openGraph: {
    title: "Доставка из Китая в Москву — ChinaBridge",
    description: "Маршрут Хэйхэ — Благовещенск от 100 кг. Срок 18–45 дней. Таможня.",
...
const FAQ = [
  {
    ...
    answer: "Сборный груз авто: от $2.5 до $4 за кг в зависимости от маршрута. Авиа стандарт: от $23/кг (5–8 дней), авиа экспресс: от $33/кг (3 дня). Контейнер 20' под ключ с растаможкой: от $5,000. Точная цена — в калькуляторе.",
  },
  {
    ...
    <main className="min-h-screen bg-[#0B1F3A] text-white">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <p className="text-[#8899aa] text-lg max-w-2xl mb-8">
          Перевозим грузы из любого города Китая в Москву. Маршрут через Хэйхэ — Благовещенск от 100 кг (3–7 дней до границы). Авто, авиа, полные контейнеры. Таможня и страхование.
        </p>
        <Link
          href="/#calculator"
      ...
      <section className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            { name: "Авто через Казахстан", time: "18–25 дней", price: "от $3.00/кг", desc: "Основной маршрут. Через Казахстан — Россия без морских пересадок." },
            ...
            { name: "Авиа стандарт", time: "5–8 дней", price: "от $23/кг", desc: "Быстрая доставка. Аэропорты Шереметьево, Домодедово, Внуково." },
            { name: "Авиа экспресс", time: "3 дня", price: "от $33/кг", desc: "Срочная доставка. От 1 кг." },
          ].map((r) => (
