...
export const metadata: Metadata = {
  ...
  description: "Оптовые поставки любых товаров из Китая в Россию и Казахстан. Офис в Гуанчжоу. Найдём поставщика на 1688 и Alibaba, проверим качество, доставим от 50 кг.",
