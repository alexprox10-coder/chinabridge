...
export const metadata: Metadata = {
  ...
  description: "Инструменты и промышленное оборудование из Китая в Россию и Казахстан. Проверим завод лично, согласуем цену, доставим с сертификатами. от 100 кг.",
