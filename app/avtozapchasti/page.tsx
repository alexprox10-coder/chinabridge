...
export const metadata: Metadata = {
  ...
  description: "Доставка автозапчастей из Китая в Россию и Казахстан. Оригинал и аналоги напрямую с завода. Белый ввоз, полные сертификаты. от 100 кг, подбор по VIN.",
