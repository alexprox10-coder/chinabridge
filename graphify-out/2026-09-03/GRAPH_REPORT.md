# Graph Report - chinabridge  (2026-09-03)

## Corpus Check
- 750 files · ~1,013,144 words
...
2. `AdminNav()` - 59 edges
3. `getDb()` - 38 edges
4. `getTenantId()` - 35 edges
5. `createLead()` - 35 edges
...
## Knowledge Gaps
- **1386 isolated node(s):** `metadata`, `jsonLd`, `runtime`, `dynamic`, `Step` (+1381 more)
...
- **What connects `metadata`, `jsonLd`, `runtime` to the rest of the system?**
