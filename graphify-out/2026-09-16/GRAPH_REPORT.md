# Graph Report - chinabridge  (2026-09-16)

## Corpus Check
- 820 files · ~1,067,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4705 nodes · 8698 edges · 316 communities (249 shown, 67 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 40 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e3a595f1`
...
Cohesion: 0.10
Nodes (26): DashboardPage(), auth(), ensureTable(), GET(), POST(), dynamic, GET(), runtime (+18 more)
...
### Community 12 - "proposals/page.tsx"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (36): Alert, ALERT_STYLE, CeoReport, CeoReportWidget(), Insight, Priority, Stats, TREND_COLOR (+28 more)
...
### Community 30 - "crm/client.ts"
Cohesion: 0.20
Nodes (16): DELETE(), dynamic, GET(), PATCH(), runtime, POST(), runtime, deleteLead() (+8 more)
...
### Community 33 - "import-kaspi/page.tsx"
Cohesion: 0.40
...
Cohesion: 0.17
Nodes (20): buildImportComment(), GET(), isAuthorized(), PATCH(), runtime, POST(), runtime, deleteLeadPermanently() (+12 more)
...
Cohesion: 0.08
Nodes (37): assessDataQuality(), buildStructuredEvidence(), computeDqScore(), deriveCompanyId(), LeadRow, maxDuration, POST(), runtime (+29 more)

### Community 44 - "generator.ts"
Cohesion: 0.13
...
Cohesion: 0.08
Nodes (28): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, detectCountry(), EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice() (+20 more)
...
Cohesion: 0.08
Nodes (18): benefits, faqs, jsonLd, metadata, inter, metadata, orgSchema, trackVkGoal() (+10 more)
...
Cohesion: 0.05
Nodes (25): competitors, jsonLd, metadata, jsonLd, metadata, RATES, jsonLd, metadata (+17 more)
...
### Community 106 - "deal-intelligence/index.ts"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (29): KzAutoAccessoriesPage(), KzAutoPartsPage(), KzForm(), metadata, metadata, RuForm(), WhiteImportPage(), CountryDetectInit() (+21 more)
...
Cohesion: 0.12
Nodes (24): WizardForm, GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration, POST() (+16 more)
...
### Community 157 - "ai-company/page.tsx"
Cohesion: 0.23
...
Cohesion: 0.05
Nodes (59): FinanceSettingsPage(), dynamic, GET(), POST(), runtime, dynamic, GET(), POST() (+51 more)
...
Cohesion: 0.12
Nodes (19): AI_LINKS, TenantDetail(), dynamic, COUNTRY_FLAG, PLAN_BADGE, TenantList(), buildAiContext(), buildAiSystemPrompt() (+11 more)

### Community 177 - "getTenantById"
Cohesion: 0.26
Nodes (10): dynamic, TenantPage(), DELETE(), GET(), isSuperAdmin(), maxDuration, PATCH(), runtime (+2 more)
...
### Community 191 - "AdminNav.tsx"
Cohesion: 0.04
Nodes (42): Message, MODELS, QUICK_PROMPTS, Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, dynamic (+34 more)
...
Cohesion: 0.07
Nodes (45): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, FinanceOrdersPage(), fmtDate(), revalidate (+37 more)

### Community 263 - "currency/route.ts"
Cohesion: 0.33
Nodes (6): CbrValute, fetchCbrRates(), GET(), RatesResult, revalidate, runtime

### Community 264 - "cargo-china-moscow/page.tsx"
Cohesion: 0.33
...
### Community 267 - "market-intelligence/leads/route.ts"
Cohesion: 0.31
...
### Community 288 - "PlatformDashboard.tsx"
Cohesion: 0.13
Nodes (14): dynamic, COUNTRY_FLAG, fmtMoney(), PLAN_BADGE, PlatformDashboard(), STATUS_DOT, BillingClient(), Plan (+6 more)
...
### Community 296 - "china-kazakhstan/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 306 - "import-electronics-from-china/page.tsx"
Cohesion: 0.33
Nodes (4): DUTIES, FAQ, metadata, schema

### Community 308 - "economics/route.ts"
Cohesion: 0.47
...
### Community 314 - "app/services/page.tsx"
Cohesion: 0.40
...
### Community 319 - "china-spb/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 331 - "notifications/route.ts"
Cohesion: 0.50
Nodes (4): GET(), maxDuration, runtime, generateNotifications()

## Knowledge Gaps
- **1534 isolated node(s):** `runtime`, `maxDuration`, `LeadRow`, `runtime`, `maxDuration` (+1529 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `campaigns/page.tsx`, `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `lib/finance/types.ts`, `ContentPageClient.tsx`, `HhLeadsClient.tsx`, `proposals/page.tsx`, `LeadDetail.tsx`, `rate-engine/types.ts`, `CeoDashboard.tsx`, `market-intelligence/db.ts`, `intelligence/page.tsx`, `ai-company/page.tsx`, `PlatformDashboard.tsx`, `CreateWizard.tsx`, `client-portal/types.ts`, `VkIntentClient.tsx`, `chat/page.tsx`, `MarketingPageClient.tsx`, `getTenantById`, `multitenant/types.ts`, `TgMonitorClient.tsx`, `market-intelligence/types.ts`, `pricing/page.tsx`, `admin/calculations/page.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `SeoClustersClient.tsx`, `WbSellersClient.tsx`, `tenders/page.tsx`, `deal-intelligence/index.ts`, `sales/data.ts`, `SalesCompaniesClient.tsx`, `ImportLead`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `lib/finance/types.ts`, `OperationsDashboard.tsx`, `MarketingDashboard.tsx`, `strategy/data.ts`, `getLeads`, `client-portal/api.ts`, `ceo/report/route.ts`, `payments/create/route.ts`, `ai-company/page.tsx`, `finance/api.ts`, `check/route.ts`, `partners/db.ts`, `setup/route.ts`, `notifications/route.ts`, `getTenantId`, `vk-ads/sync/route.ts`, `sales/data.ts`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `createLead()` connect `createLead` to `partner-portal/api.ts`, `finance/api.ts`, `tender-intelligence/route.ts`, `calculator.ts`, `import-leads/crm.ts`, `getLeads`, `market-intelligence/leads/route.ts`, `vk-ads/sync/route.ts`, `economics/route.ts`, `api/leads/route.ts`, `crm/client.ts`, `memory.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **What connects `runtime`, `maxDuration`, `LeadRow` to the rest of the system?**
