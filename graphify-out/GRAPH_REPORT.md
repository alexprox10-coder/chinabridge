# Graph Report - chinabridge  (2026-08-25)

## Corpus Check
- 688 files · ~977,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3960 nodes · 7491 edges · 265 communities (221 shown, 44 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dfb136e9`
...
5. `getSession()` - 34 edges
6. `createLead()` - 31 edges
...
Cohesion: 0.05
Nodes (30): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus, Partner (+22 more)

### Community 10 - "VkIntentClient.tsx"
Cohesion: 0.20
...
### Community 12 - "b2bchina-alternative/page.tsx"
Cohesion: 0.40
...
Cohesion: 0.12
Nodes (20): DELETE(), runtime, DELETE(), runtime, DELETE(), runtime, DELETE(), runtime (+12 more)
...
Cohesion: 0.19
Nodes (15): GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration, POST(), runtime (+7 more)

### Community 19 - "LeadDetail.tsx"
Cohesion: 0.10
Nodes (20): dynamic, revalidate, ALL_STATUSES, COLUMNS, LeadCard(), msAgo(), timeLabel(), FinanceTab() (+12 more)

### Community 20 - "market-intelligence/types.ts"
Cohesion: 0.19
...
Cohesion: 0.04
Nodes (60): dynamic, GET(), runtime, dynamic, GET(), POST(), runtime, dynamic (+52 more)

### Community 22 - "lib/finance/types.ts"
Cohesion: 0.09
Nodes (34): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, FinanceOrdersPage(), fmtDate(), revalidate (+26 more)

### Community 23 - "pricing-engine.ts"
Cohesion: 0.24
Nodes (14): escapeNonAscii(), POST(), runtime, calculateCostBreakdown(), CostEngineInput, buildReason(), ruleMatchesInput(), selectPricingRule() (+6 more)
...
Cohesion: 0.16
Nodes (18): POST(), runtime, POST(), runtime, ipAttempts, maxDuration, notifyAdminNewRegistration(), POST() (+10 more)
...
Cohesion: 0.11
Nodes (19): BLANK, CARGO_TYPES, CURRENCIES, RATE_TYPES, SOURCE_BADGE, TRANSPORT_TYPES, BLANK, TRANSPORT_TYPES (+11 more)
...
Cohesion: 0.21
Nodes (16): POST(), runtime, applyRules(), calcBaseCost(), calcServiceCost(), calculateDeliveryCost(), saveCalculation(), getDefaultTransportType() (+8 more)
...
### Community 43 - "deal-intelligence/index.ts"
Cohesion: 0.20
Nodes (12): dynamic, GET(), getTenantId(), runtime, analyzeDealIntelligence(), calcForecast(), scoreDeal(), STATUS_BASE (+4 more)
...
Cohesion: 0.07
Nodes (42): dynamic, loadReport(), metadata, SalesPage(), PRIO, Priority, SalesDashboard(), Tab (+34 more)

### Community 47 - "proposals/types.ts"
Cohesion: 0.15
Nodes (16): dynamic, MODE_COLORS, ProposalsPage(), revalidate, STATUS_COLORS, STATUS_LABELS, POST(), runtime (+8 more)
...
Cohesion: 0.10
Nodes (19): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice(), ExtractedProduct (+11 more)

### Community 51 - "market-intelligence/leads/route.ts"
Cohesion: 0.14
...
### Community 53 - "analytics/index.ts"
Cohesion: 0.29
Nodes (8): YandexMetrika(), Cases, analytics, fire(), METRIKA_ID, reachGoal(), trackMetrikaPageView(), Window
...
Cohesion: 0.13
Nodes (13): POST(), runtime, POST(), runtime, POST(), runtime, POST(), runtime (+5 more)

### Community 59 - "multitenant/types.ts"
Cohesion: 0.10
Nodes (21): dynamic, COUNTRY_FLAG, fmtMoney(), PLAN_BADGE, PlatformDashboard(), STATUS_DOT, BillingClient(), Plan (+13 more)
...
Cohesion: 0.35
Nodes (10): GET(), runtime, bootstrap(), getOrCreateLink(), getSql(), getStats(), nowIso(), PartnerStats (+2 more)

### Community 63 - "vk-intent/pipeline.ts"
Cohesion: 0.09
Nodes (30): dynamic, GET(), maxDuration, runtime, dynamic, maxDuration, POST(), runtime (+22 more)
...
### Community 65 - "finance/settings/page.tsx"
Cohesion: 0.17
Nodes (13): dynamic, FinanceSettingsPage(), revalidate, dynamic, GET(), PUT(), runtime, FinanceSettingsForm() (+5 more)

### Community 66 - "createLead"
Cohesion: 0.15
Nodes (14): dynamic, isAuthorized(), POST(), runtime, scoreFromReviews(), POST(), POST(), maxDuration (+6 more)

### Community 67 - "CeoReportWidget.tsx"
Cohesion: 0.20
...
### Community 69 - "generator.ts"
Cohesion: 0.17
Nodes (15): generateProposal(), generateProposalNumber(), ProposalDocument(), ROBOTO_BOLD_B64, ROBOTO_LIGHT_B64, ROBOTO_REGULAR_B64, registerFonts(), getMissingFields() (+7 more)
...
### Community 71 - "getLeads"
Cohesion: 0.33
Nodes (10): DashboardPage(), auth(), ensureTable(), GET(), POST(), dynamic, GET(), runtime (+2 more)

### Community 72 - "payments/create/route.ts"
Cohesion: 0.13
Nodes (26): maxDuration, POST(), runtime, GET(), maxDuration, runtime, maxDuration, POST() (+18 more)

### Community 73 - "UnifiedLeadsDashboard.tsx"
Cohesion: 0.15
Nodes (13): ACTION_BUTTONS, LeadSystem, MI_TO_UNIFIED, normalizeImport(), normalizeMI(), SOURCE_ICON, STATUS_COLORS, STATUS_LABELS (+5 more)

### Community 74 - "SeoClustersClient.tsx"
Cohesion: 0.13
Nodes (12): dynamic, Brief, ClusterGroup, COMP_COLOR, COMP_LABEL, GROUP_LABELS, SeoClustersClient(), Stats (+4 more)

### Community 75 - "economics/route.ts"
Cohesion: 0.21
Nodes (9): checkAndIncrement(), getIp(), maxDuration, POST(), runtime, EconomicsResult, getSystemRates(), INTEL_MP_KEYS (+1 more)
...
Cohesion: 0.22
Nodes (12): EconomicsScenario, ProductScore, SupplierRiskResult, TargetPrice, buildScenario(), calculateUnitEconomics(), computeProductScore(), computeSupplierRisk() (+4 more)

### Community 78 - "PersonalOfferWidget.tsx"
Cohesion: 0.18
...
### Community 84 - "ai-company/page.tsx"
Cohesion: 0.23
...
### Community 86 - "[id]/offer/route.ts"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (19): buildUtm(), Campaign, CampaignsPage(), CHANNEL_ICONS, CHANNELS, slugify(), STATUS_COLORS, STATUS_LABELS (+11 more)
...
### Community 93 - "finance/api.ts"
Cohesion: 0.06
Nodes (52): FinanceDashboardPage(), dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), POST() (+44 more)

### Community 94 - "download/[id]/route.ts"
Cohesion: 0.28
...
### Community 98 - "tenants/[id]/route.ts"
Cohesion: 0.24
Nodes (12): ensureLinksTable(), POST(), runtime, sql, DELETE(), GET(), isSuperAdmin(), maxDuration (+4 more)

### Community 99 - "calculator/types.ts"
Cohesion: 0.15
Nodes (16): AI_STEPS, CalculatorForm(), CITY_CHIPS, initialFormData, inp(), CalculatorFormData, CalculatorResult, CARGO_TYPE_ICONS (+8 more)
...
### Community 101 - "DealIntelligenceClient.tsx"
Cohesion: 0.20
Nodes (5): ALERT_COLORS, DealIntelligenceClient(), RISK_COLORS, dynamic, DealIntelligenceResult
...
### Community 104 - "ai-funnel/submit/route.ts"
Cohesion: 0.27
Nodes (10): getAiAnalysis(), maxDuration, POST(), runtime, saveProductAnalysis(), sendTelegramAlert(), detectCommissionPct(), getCommission() (+2 more)
...
### Community 106 - "ai-sales-agent/route.ts"
Cohesion: 0.36
...
Cohesion: 0.18
Nodes (15): dynamic, POST(), runtime, WORKFLOWS, checkExposedRoutes(), checkSecurityHeaders(), dynamic, fixCrmTestTenant() (+7 more)
...
### Community 118 - "ProductFinderUI.tsx"
Cohesion: 0.40
...
### Community 124 - "context.ts"
Cohesion: 0.22
Nodes (10): BillingPage(), dynamic, TenantPage(), getCurrentTenant(), isSuperAdmin(), requireSuperAdmin(), getTenantByDomain(), getTenantById() (+2 more)
...
### Community 135 - "SalesCompaniesClient.tsx"
Cohesion: 0.18
...
### Community 138 - "Footer.tsx"
Cohesion: 0.07
Nodes (25): jsonLd, metadata, metadata, metadata, metadata, jsonLd, metadata, FAQS (+17 more)

### Community 139 - "contact-alert/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, POST(), runtime, sendTelegram()

### Community 140 - "TenantList.tsx"
Cohesion: 0.33
...
### Community 142 - "ImportLead"
Cohesion: 0.15
Nodes (15): IMPORTS_LABELS, Props, SCORE_COLORS, STATUS_LABELS, STATUS_STYLES, UnifiedLead, buildImportComment(), GET() (+7 more)

### Community 143 - "app/services/page.tsx"
Cohesion: 0.12
...
### Community 146 - "CreateWizard.tsx"
Cohesion: 0.13
Nodes (13): AI_MODULES, COUNTRIES, CreateWizard(), CURRENCIES, INDUSTRIES, PRESET_COLORS, STEPS, TIMEZONES (+5 more)

### Community 147 - "LeadMagnetForm.tsx"
Cohesion: 0.11
Nodes (12): benefits, faqs, jsonLd, metadata, inter, metadata, trackVkGoal(), VkPixel() (+4 more)

### Community 148 - "telegram.ts"
Cohesion: 0.31
...
### Community 150 - "import-leads/status-store.ts"
Cohesion: 0.57
Nodes (7): DELETE(), ensureTable(), getDeletedLeadIds(), getLeadStatuses(), markLeadDeleted(), setLeadStatus(), sql

### Community 151 - "knowledge/chat/route.ts"
Cohesion: 0.40
...
### Community 160 - "supplier-finder/route.ts"
Cohesion: 0.47
...
### Community 162 - "import-leads/crm.ts"
Cohesion: 0.10
Nodes (28): dynamic, GET(), maxDuration, GET(), isAuthorized(), POST(), runtime, GET() (+20 more)

### Community 163 - "supplier-wildberries-china/page.tsx"
Cohesion: 0.33
...
Cohesion: 0.13
Nodes (23): dynamic, LeadPage(), revalidate, DELETE(), dynamic, GET(), PATCH(), runtime (+15 more)

### Community 169 - "admin/services/page.tsx"
Cohesion: 0.33
Nodes (4): BLANK, CURRENCIES, PRESETS, PriceType

### Community 170 - "payments/[id]/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, PATCH(), runtime, updatePayment()

### Community 171 - "expenses/[id]/route.ts"
Cohesion: 0.50
...
### Community 174 - "multitenant/ai-context.ts"
Cohesion: 0.39
...
### Community 201 - "FulfilmentClient.tsx"
Cohesion: 0.33
...
### Community 230 - "china-blagoveshchensk/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 255 - "china-spb/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 256 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 259 - "wildberries-margin-calculator/page.tsx"
Cohesion: 0.40
Nodes (3): jsonLd, metadata, wbRates2026

### Community 260 - "notifications/route.ts"
Cohesion: 0.38
Nodes (5): GET(), maxDuration, runtime, generateNotifications(), CeoNotification

### Community 267 - "FAQSection.tsx"
Cohesion: 0.11
Nodes (14): FAQ, metadata, schema, FAQ, metadata, schema, FAQ_CUSTOMS, FAQ_DELIVERY (+6 more)
...
## Knowledge Gaps
- **1288 isolated node(s):** `dynamic`, `HEADERS`, `FETCH_HEADERS`, `AVITO_QUERIES`, `AvitoItem` (+1283 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `SalesCompaniesClient.tsx`, `VkIntentClient.tsx`, `ContentPageClient.tsx`, `TenantList.tsx`, `CreateWizard.tsx`, `LeadDetail.tsx`, `market-intelligence/types.ts`, `lib/finance/types.ts`, `CeoDashboard.tsx`, `market-intelligence/db.ts`, `intelligence/page.tsx`, `rate-engine/types.ts`, `AiSalesAgentClient.tsx`, `crm/client.ts`, `admin/services/page.tsx`, `pricing/page.tsx`, `sales/data.ts`, `proposals/types.ts`, `MarketingPageClient.tsx`, `multitenant/types.ts`, `finance/settings/page.tsx`, `SeoClustersClient.tsx`, `ai-cto/db.ts`, `ai-company/page.tsx`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `finance/api.ts`, `WbSellersClient.tsx`, `DealIntelligenceClient.tsx`, `HhLeadsClient.tsx`, `admin/calculations/page.tsx`, `context.ts`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `notifications/route.ts`, `analytics/data.ts`, `content/data.ts`, `OperationsDashboard.tsx`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `strategy/data.ts`, `ceo/report/route.ts`, `lib/finance/types.ts`, `supplier-finder/route.ts`, `payments/[id]/route.ts`, `expenses/[id]/route.ts`, `sales/data.ts`, `finance/settings/page.tsx`, `createLead`, `getLeads`, `payments/create/route.ts`, `ai-company/page.tsx`, `setup/route.ts`, `finance/api.ts`, `vk-ads/sync/route.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `createLead()` connect `createLead` to `vk-ads/sync/route.ts`, `partner-portal/api.ts`, `getLeads`, `ai-funnel/submit/route.ts`, `crm/client.ts`, `economics/route.ts`, `ImportLead`, `market-intelligence/leads/route.ts`, `api/leads/route.ts`, `pricing-engine.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **What connects `dynamic`, `HEADERS`, `FETCH_HEADERS` to the rest of the system?**
