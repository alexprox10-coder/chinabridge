# Graph Report - chinabridge  (2026-09-07)

## Corpus Check
- 757 files · ~1,018,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4369 nodes · 8166 edges · 307 communities (251 shown, 56 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d4e6bab`
...
Cohesion: 0.12
Nodes (24): dynamic, TenantPage(), GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration (+16 more)
...
Cohesion: 0.10
Nodes (21): RateBenchmark, revalidate, runtime, DELETE(), runtime, DELETE(), runtime, DELETE() (+13 more)
...
Cohesion: 0.10
Nodes (26): AiOsDashboard(), PRIORITY_CONFIG, Props, STATUS_CONFIG, AiCompanyPage(), dynamic, loadInitialReport(), metadata (+18 more)
...
Cohesion: 0.17
Nodes (16): maxDuration, POST(), runtime, ensureLinksTable(), GET(), getSql(), maxDuration, POST() (+8 more)

### Community 23 - "AdminNav.tsx"
Cohesion: 0.06
Nodes (19): dynamic, Question, metadata, GROUP_COLOR, KwRow, TRAFFIC_COLOR, dynamic, Partner (+11 more)
...
Cohesion: 0.18
Nodes (22): MarketIntelligencePage(), dynamic, GET(), maxDuration, GET(), dynamic, GET(), getTenantId() (+14 more)
...
Cohesion: 0.10
Nodes (15): DocumentsPage(), CITIES, CreateOrderForm(), ClientDocument, ClientMessage, ClientOrder, ClientRole, DOC_TYPE_LABELS (+7 more)

### Community 38 - "cargo-consolidation/page.tsx"
Cohesion: 0.14
Nodes (10): CITIES, metadata, FAQ, metadata, schema, FAQ, metadata, schema (+2 more)

### Community 39 - "tender/types.ts"
Cohesion: 0.12
Nodes (27): EISSearchItem, extractFromHtml(), fetchRecentWinners(), mapItem(), parseNum(), SEARCH_PARAMS, buildOpportunity(), calcIntentScore() (+19 more)
...
### Community 44 - "getLeads"
Cohesion: 0.25
Nodes (13): DashboardPage(), auth(), ensureTable(), GET(), POST(), GET(), fallbackTasks(), GET() (+5 more)
...
Cohesion: 0.09
Nodes (23): CATEGORIES, CITIES, ImportCategoryPage(), NotFound(), CITIES, Step, WhiteImportPage(), GAInner() (+15 more)

### Community 47 - "getTenantId"
Cohesion: 0.13
Nodes (17): dynamic, GET(), POST(), runtime, dynamic, GET(), POST(), runtime (+9 more)
...
Cohesion: 0.09
Nodes (24): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice(), ExtractedProduct (+16 more)

### Community 51 - "sales/data.ts"
Cohesion: 0.07
...
### Community 66 - "crm/client.ts"
Cohesion: 0.09
Nodes (27): dynamic, LeadPage(), revalidate, DELETE(), dynamic, GET(), PATCH(), runtime (+19 more)

### Community 67 - "reports/page.tsx"
Cohesion: 0.16
Nodes (15): FinanceDashboardPage(), dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), POST() (+7 more)
...
Cohesion: 0.15
Nodes (35): authOk(), maxDuration, POST(), runtime, dynamic, GET(), PATCH(), authOk() (+27 more)
...
### Community 71 - "RadarClient.tsx"
Cohesion: 0.17
Nodes (9): dynamic, DEMO_SIGNALS, RadarClient(), Tab, TAB_DEFS, TYPE_COLOR, MIRadarSignal, RADAR_TYPE_LABELS (+1 more)
...
Cohesion: 0.14
Nodes (14): ACTION_BUTTONS, LeadSystem, MI_TO_UNIFIED, normalizeImport(), normalizeMI(), SOURCE_ICON, STATUS_COLORS, STATUS_LABELS (+6 more)

### Community 74 - "CreateWizard.tsx"
Cohesion: 0.15
Nodes (12): AI_MODULES, COUNTRIES, CreateWizard(), CURRENCIES, INDUSTRIES, PRESET_COLORS, STEPS, TIMEZONES (+4 more)

### Community 75 - "market-intelligence/types.ts"
Cohesion: 0.16
...
### Community 77 - "CeoReportWidget.tsx"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (15): checkRateLimit(), getIp(), maxDuration, POST(), runtime, ALLOWED, detectPlatform(), FieldConfidence (+7 more)
...
### Community 84 - "LeadMagnetForm.tsx"
Cohesion: 0.22
...
### Community 90 - "deal-intelligence/index.ts"
Cohesion: 0.18
Nodes (13): dynamic, dynamic, GET(), getTenantId(), runtime, analyzeDealIntelligence(), calcForecast(), scoreDeal() (+5 more)
...
### Community 94 - "proposals/types.ts"
Cohesion: 0.11
Nodes (22): dynamic, MODE_COLORS, ProposalsPage(), revalidate, STATUS_COLORS, STATUS_LABELS, POST(), runtime (+14 more)
...
### Community 101 - "briefing/route.ts"
Cohesion: 0.38
...
Cohesion: 0.26
Nodes (12): calculateCostBreakdown(), CostEngineInput, buildReason(), ruleMatchesInput(), selectPricingRule(), CostBreakdown, PricingSelection, PricingSelectorInput (+4 more)
...
Cohesion: 0.24
Nodes (8): YandexMetrika(), Cases, CATEGORY_MAP, fire(), METRIKA_ID, reachGoal(), trackMetrikaPageView(), Window

### Community 107 - "HhLeadsClient.tsx"
Cohesion: 0.29
Nodes (6): Filter, HhExtra, HhLeadsClient(), parseExtra(), КАТ_COLOR, КАТ_LABEL
...
### Community 113 - "Footer.tsx"
Cohesion: 0.10
Nodes (12): metadata, jsonLd, metadata, FAQS, metadata, STEPS, companyLinks, importLinks (+4 more)

### Community 114 - "admin/leads/route.ts"
Cohesion: 0.33
Nodes (10): DELETE(), dynamic, runtime, deleteLeadPermanently(), ensureTable(), getDeletedLeadIds(), getLeadStatuses(), markLeadDeleted() (+2 more)

### Community 115 - "finance/api.ts"
Cohesion: 0.10
Nodes (34): dynamic, PATCH(), runtime, dynamic, GET(), POST(), runtime, dynamic (+26 more)
...
### Community 122 - "check/route.ts"
Cohesion: 0.23
Nodes (16): GET(), maxDuration, runtime, dynamic, ensureLinksTable(), POST(), runtime, sql (+8 more)

### Community 123 - "presentation/page.tsx"
Cohesion: 0.22
Nodes (7): AUDIENCE, FEATURES, FORMATS, metadata, PROBLEMS, WHY, PrintButton()

### Community 124 - "finance/settings/page.tsx"
Cohesion: 0.17
...
Cohesion: 0.20
Nodes (16): getAiAnalysis(), maxDuration, POST(), runtime, saveProductAnalysis(), sendTelegramAlert(), buildScenario(), calculateUnitEconomics() (+8 more)
...
Cohesion: 0.13
Nodes (26): dynamic, GET(), POST(), runtime, GET(), runtime, GET(), POST() (+18 more)

### Community 139 - "contact-alert/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, POST(), runtime, sendTelegram()

### Community 140 - "vk-ads/sync/route.ts"
Cohesion: 0.24
Nodes (11): GET(), getToken(), leadToContact(), maxDuration, mtGet(), POST(), runSync(), runtime (+3 more)

### Community 141 - "import-leads/crm.ts"
Cohesion: 0.12
Nodes (24): analyzeLeadsWithAI(), GET(), isAuthorized(), LeadRecommendation, maxDuration, POST(), runtime, GET() (+16 more)

### Community 142 - "clusters.ts"
Cohesion: 0.16
Nodes (15): auth(), GET(), getDynamicKeywords(), POST(), ensureTable(), GET(), POST(), Competition (+7 more)

### Community 143 - "analyze-text/route.ts"
Cohesion: 0.50
...
### Community 146 - "isAdminOnly"
Cohesion: 0.24
Nodes (8): dynamic, POST(), runtime, WORKFLOWS, maxDuration, POST(), runtime, isAdminOnly()

### Community 147 - "multitenant/types.ts"
Cohesion: 0.08
Nodes (30): COUNTRY_FLAG, fmtMoney(), PLAN_BADGE, PlatformDashboard(), STATUS_DOT, BillingClient(), Plan, PLAN_BTN (+22 more)
...
### Community 150 - "client/layout.tsx"
Cohesion: 0.29
Nodes (6): ClientLayout(), metadata, AI_NAV, ClientNav(), NAV, SessionPayload

### Community 151 - "SalesCompaniesClient.tsx"
Cohesion: 0.18
...
Cohesion: 0.22
Nodes (11): ipAttempts, maxDuration, notifyAdminNewRegistration(), POST(), runtime, makeId(), maxDuration, now() (+3 more)
...
### Community 162 - "createLead"
Cohesion: 0.11
Nodes (21): dynamic, isAuthorized(), POST(), runtime, scoreFromReviews(), escapeNonAscii(), handlePost(), notifyManagerTelegram() (+13 more)
...
### Community 167 - "tenders/page.tsx"
Cohesion: 0.24
...
### Community 171 - "generator.ts"
Cohesion: 0.24
Nodes (10): generateProposal(), generateProposalNumber(), ProposalDocument(), ROBOTO_BOLD_B64, ROBOTO_LIGHT_B64, ROBOTO_REGULAR_B64, registerFonts(), detectServiceKey() (+2 more)
...
### Community 174 - "DealIntelligenceClient.tsx"
Cohesion: 0.20
Nodes (5): ALERT_COLORS, DealIntelligenceClient(), RISK_COLORS, dynamic, DealScore

### Community 175 - "download/[id]/route.ts"
Cohesion: 0.28
...
### Community 180 - "tenants/[id]/route.ts"
Cohesion: 0.39
...
### Community 191 - "campaigns/page.tsx"
Cohesion: 0.28
...
### Community 194 - "tripwire/route.ts"
Cohesion: 0.40
Nodes (5): dynamic, ensureTable(), POST(), runtime, tochkaAgent
...
### Community 201 - "VkAdsDashboard.tsx"
Cohesion: 0.29
...
### Community 267 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
...
### Community 269 - "admin/calculations/page.tsx"
Cohesion: 0.38
...
### Community 277 - "marketplaces.ts"
Cohesion: 0.24
Nodes (7): dynamic, PATCH(), runtime, upsertMpRate(), getCommission(), MarketplaceConfig, MARKETPLACES

### Community 278 - "notifications/route.ts"
Cohesion: 0.38
Nodes (5): GET(), maxDuration, runtime, generateNotifications(), CeoNotification

### Community 279 - "update-rates.mjs"
Cohesion: 0.26
Nodes (11): addRows(), env, envPath, getRows(), headers, main(), n8n(), NEW_RATES (+3 more)
...
### Community 287 - "import-leads/leads/route.ts"
Cohesion: 0.48
...
### Community 294 - "integrations/page.tsx"
Cohesion: 0.40
Nodes (3): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus

### Community 295 - "registrations/page.tsx"
Cohesion: 0.47
Nodes (5): Client, COUNTRY_FLAG, daysSince(), fmt(), RegistrationsPage()

### Community 296 - "knowledge/chat/route.ts"
Cohesion: 0.40
Nodes (5): maxDuration, POST(), runtime, saveQuestion(), ALL_KNOWLEDGE

### Community 298 - "product-finder/route.ts"
Cohesion: 0.47
Nodes (5): checkLimit(), getIp(), maxDuration, POST(), runtime

### Community 299 - "CTASection.tsx"
Cohesion: 0.13
Nodes (11): FAQ, metadata, schema, FAQ, metadata, schema, FAQ, metadata (+3 more)

### Community 300 - "app/services/page.tsx"
Cohesion: 0.40
Nodes (3): metadata, SERVICE_LINKS, Services

### Community 302 - "china-delivery/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 303 - "supplier-wildberries-china/page.tsx"
Cohesion: 0.33
Nodes (4): jsonLd, metadata, niches, steps

### Community 304 - "b2bchina-alternative/page.tsx"
Cohesion: 0.40
Nodes (3): competitors, jsonLd, metadata

### Community 305 - "inspection/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

## Knowledge Gaps
- **1400 isolated node(s):** `runtime`, `maxDuration`, `Step`, `ProductData`, `ExtractedProduct` (+1395 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `lib/finance/types.ts`, `store.ts`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `admin/calculations/page.tsx`, `AiOsDashboard.tsx`, `LeadDetail.tsx`, `pricing/page.tsx`, `multitenant/types.ts`, `SalesCompaniesClient.tsx`, `intelligence/page.tsx`, `rate-engine/types.ts`, `integrations/page.tsx`, `tenders/page.tsx`, `VkIntentClient.tsx`, `registrations/page.tsx`, `TgMonitorClient.tsx`, `DealIntelligenceClient.tsx`, `MarketingPageClient.tsx`, `sales/data.ts`, `campaigns/page.tsx`, `crm/client.ts`, `reports/page.tsx`, `RadarClient.tsx`, `VkAdsDashboard.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `deal-intelligence/index.ts`, `outreach-leads/page.tsx`, `proposals/types.ts`, `WbSellersClient.tsx`, `ImportLead`, `finance/settings/page.tsx`, `chat/page.tsx`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `createLead()` connect `createLead` to `partner-portal/api.ts`, `crm/client.ts`, `tender-intelligence/route.ts`, `calculator.ts`, `market-intelligence/types.ts`, `vk-ads/sync/route.ts`, `getTenantId`, `admin/leads/route.ts`, `finance/api.ts`, `api/leads/route.ts`, `economics/route.ts`, `import-leads/leads/route.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `lib/finance/types.ts`, `OperationsDashboard.tsx`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `strategy/data.ts`, `vk-ads/campaigns/route.ts`, `vk-ads/sync/route.ts`, `ceo/report/route.ts`, `AiOsDashboard.tsx`, `notifications/route.ts`, `product-finder/route.ts`, `getLeads`, `getTenantId`, `sales/data.ts`, `partners/db.ts`, `reports/page.tsx`, `setup/route.ts`, `admin/leads/route.ts`, `finance/api.ts`, `check/route.ts`, `finance/settings/page.tsx`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **What connects `runtime`, `maxDuration`, `Step` to the rest of the system?**
