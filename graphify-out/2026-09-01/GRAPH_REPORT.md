# Graph Report - chinabridge  (2026-09-01)

## Corpus Check
- 744 files · ~1,009,536 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4294 nodes · 8068 edges · 298 communities (243 shown, 55 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `988786b8`
...
### Community 10 - "Footer"
Cohesion: 0.12
Nodes (12): metadata, FulfilmentClient(), MARKETS, SERVICES, STEPS, WAREHOUSES, metadata, FAQS (+4 more)
...
Cohesion: 0.13
Nodes (26): GET(), maxDuration, POST(), QUICK_OVERRIDES, runtime, analyzeWebsite(), orAnalyze(), scrapeWebsite() (+18 more)

### Community 15 - "rate-engine/db.ts"
Cohesion: 0.11
Nodes (23): DELETE(), runtime, POST(), runtime, DELETE(), runtime, DELETE(), runtime (+15 more)
...
Cohesion: 0.08
Nodes (28): Alert, ALERT_STYLE, CeoReport, CeoReportWidget(), Insight, Priority, Stats, TREND_COLOR (+20 more)

### Community 20 - "pricing-engine.ts"
Cohesion: 0.17
Nodes (19): checkAndIncrement(), getIp(), maxDuration, POST(), runtime, EconomicsResult, calculateCostBreakdown(), CostEngineInput (+11 more)

### Community 21 - "isAuthorized"
Cohesion: 0.04
Nodes (57): dynamic, GET(), runtime, dynamic, GET(), runtime, dynamic, GET() (+49 more)

### Community 22 - "getSession"
Cohesion: 0.18
...
Cohesion: 0.22
Nodes (17): buildMIComment(), dynamic, GET(), getTenantId(), maxDuration, PATCH(), POST(), runtime (+9 more)
...
Cohesion: 0.25
Nodes (14): POST(), runtime, applyRules(), calcBaseCost(), calcServiceCost(), calculateDeliveryCost(), saveCalculation(), getDefaultTransportType() (+6 more)
...
Cohesion: 0.09
Nodes (30): dynamic, LeadPage(), revalidate, dynamic, isAuthorized(), POST(), runtime, scoreFromReviews() (+22 more)
...
### Community 46 - "SalesDashboard.tsx"
Cohesion: 0.10
Nodes (19): PRIO, Priority, Tab, TEMP_CFG, GET(), POST(), runtime, DirectorAnalysis (+11 more)

### Community 47 - "ai-funnel/submit/route.ts"
Cohesion: 0.16
Nodes (14): dynamic, PATCH(), runtime, upsertMpRate(), getAiAnalysis(), maxDuration, POST(), runtime (+6 more)
...
Cohesion: 0.07
Nodes (11): metadata, schemaOrg, Advantages, Directions, faqs, CARDS, COMPARISON_ROWS, GtdCompareBlock() (+3 more)

### Community 50 - "AIEconomicsFunnel.tsx"
Cohesion: 0.09
Nodes (23): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice(), ExtractedProduct (+15 more)

### Community 51 - "trackGAEvent"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (13): POST(), runtime, POST(), runtime, POST(), runtime, SEED_PRICING_RULES, SeedRule (+5 more)
...
Cohesion: 0.10
Nodes (34): maxDuration, POST(), runtime, GET(), maxDuration, runtime, maxDuration, POST() (+26 more)
...
Cohesion: 0.22
Nodes (11): buildScenario(), calculateUnitEconomics(), computeProductScore(), computeSupplierRisk(), computeTargetPrice(), EconomicsInput, EconomicsOutput, calcMarketplaceLogisticsPerUnit() (+3 more)
...
Cohesion: 0.07
Nodes (40): FinanceSettingsPage(), dynamic, PATCH(), runtime, dynamic, GET(), POST(), runtime (+32 more)
...
Cohesion: 0.22
Nodes (7): AUDIENCE, FAQ, FEATURES, FORMATS, PROBLEMS, SAAS_PLANS, Calculator()
...
Cohesion: 0.10
Nodes (22): ADVANTAGES, AI_STEPS, CalculatorForm(), CITY_CHIPS, initialFormData, inp(), CHAIN, CalculatorFormData (+14 more)
...
Cohesion: 0.20
Nodes (14): dynamic, GET(), PATCH(), runtime, dynamic, GET(), POST(), runtime (+6 more)

### Community 115 - "signup/route.ts"
Cohesion: 0.20
...
### Community 124 - "getDb"
Cohesion: 0.06
Nodes (54): BillingClient(), Plan, PLAN_BTN, PLAN_COLOR, BillingPage(), dynamic, dynamic, TenantPage() (+46 more)

### Community 125 - "ai-sales-agent/route.ts"
Cohesion: 0.36
...
### Community 143 - "pricing/page.tsx"
Cohesion: 0.15
Nodes (11): BLANK, CUSTOMER_COLORS, CUSTOMER_LABELS, FilterKey, FxRate, MpRate, PricingPage(), RULE_LABELS (+3 more)
...
### Community 147 - "PlatformDashboard.tsx"
Cohesion: 0.22
...
### Community 162 - "cashflow/route.ts"
Cohesion: 0.27
...
### Community 167 - "integrations/page.tsx"
Cohesion: 0.40
Nodes (3): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus

### Community 168 - "registrations/page.tsx"
Cohesion: 0.47
...
### Community 171 - "knowledge/chat/route.ts"
Cohesion: 0.40
...
### Community 174 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
...
### Community 201 - "LeadMagnetForm.tsx"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (40): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, FinanceOrdersPage(), fmtDate(), revalidate (+32 more)

### Community 263 - "currency/route.ts"
Cohesion: 0.33
Nodes (6): CbrValute, fetchCbrRates(), GET(), RatesResult, revalidate, runtime

### Community 264 - "import-leads/leads/route.ts"
Cohesion: 0.48
...
### Community 267 - "Footer.tsx"
Cohesion: 0.13
Nodes (10): competitors, jsonLd, metadata, FAQ, metadata, companyLinks, importLinks, navLinks (+2 more)

### Community 268 - "telegram-capture/route.ts"
Cohesion: 0.83
Nodes (3): ensureTable(), notifyManager(), POST()

### Community 269 - "china-kazakhstan/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 277 - "getLeads"
Cohesion: 0.12
Nodes (28): DashboardPage(), dynamic, MarketIntelligencePage(), auth(), ensureTable(), GET(), POST(), GET() (+20 more)

### Community 278 - "Header.tsx"
Cohesion: 0.14
Nodes (9): jsonLd, metadata, jsonLd, metadata, niches, steps, navLinks, pageLinks (+1 more)

### Community 279 - "import-leads/crm.ts"
Cohesion: 0.12
Nodes (26): dynamic, GET(), maxDuration, GET(), isAuthorized(), POST(), runtime, DELETE() (+18 more)

### Community 280 - "market-intelligence/types.ts"
Cohesion: 0.10
Nodes (15): ALERT_COLORS, DealIntelligenceClient(), RISK_COLORS, dynamic, PIPE_COLORS, SOURCE_ICON, Tab, TEMP_COLORS (+7 more)

### Community 281 - "company-enrich/route.ts"
Cohesion: 0.27
Nodes (7): ContactInfo, dynamic, EgrulRaw, extractText(), fetchEgrul(), fetchRusprofile(), GET()

### Community 282 - "inspection/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 287 - "TochkaLinksSection.tsx"
Cohesion: 0.38
Nodes (6): fmtAmount(), fmtDate(), PaymentLink, STATUS_LABEL, STATUS_STYLE, TochkaLinksSection()

### Community 288 - "analyze-text/route.ts"
Cohesion: 0.50
Nodes (3): maxDuration, POST(), runtime

### Community 290 - "marketing/partners/page.tsx"
Cohesion: 0.33
Nodes (4): Partner, PLATFORMS, STATUS_COLORS, STATUSES

### Community 291 - "audit/route.ts"
Cohesion: 0.47
Nodes (5): callAuditLLM(), fetchSiteText(), maxDuration, POST(), runtime

### Community 292 - "search.ts"
Cohesion: 0.53
Nodes (5): deduplicateByDomain(), firecrawlSearch(), searchCompanies(), skipNonTargets(), SearchResult

### Community 294 - "payments/[id]/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, PATCH(), runtime, updatePayment()

### Community 295 - "calculator/submit/route.ts"
Cohesion: 0.60
Nodes (4): escapeNonAscii(), notifyManagerTelegram(), POST(), runtime

### Community 296 - "import-leads/route.ts"
Cohesion: 0.50
Nodes (4): POST(), runtime, dtInsert(), saveLead()

### Community 297 - "app/[slug]/page.tsx"
Cohesion: 0.83
Nodes (3): generateMetadata(), getPage(), SeoPage

## Knowledge Gaps
- **1374 isolated node(s):** `NicheConfig`, `ExtractedPost`, `AnalyticsRow`, `CrmStats`, `DemoChannel` (+1369 more)
...
- **Why does `AdminNav()` connect `AdminNav` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `SalesCompaniesClient.tsx`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `pricing/page.tsx`, `LeadDetail.tsx`, `PlatformDashboard.tsx`, `getLeads`, `tenders/page.tsx`, `ai-company/page.tsx`, `CeoDashboard.tsx`, `market-intelligence/types.ts`, `intelligence/page.tsx`, `rate-engine/types.ts`, `marketing/partners/page.tsx`, `AdminNav.tsx`, `client-portal/types.ts`, `crm/client.ts`, `integrations/page.tsx`, `VkIntentClient.tsx`, `registrations/page.tsx`, `TgMonitorClient.tsx`, `MarketingPageClient.tsx`, `TenantList.tsx`, `sales/data.ts`, `CreateWizard.tsx`, `VkAdsDashboard.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `proposals/page.tsx`, `WbSellersClient.tsx`, `chat/page.tsx`, `HhLeadsClient.tsx`, `ImportLead`, `RadarClient.tsx`, `getDb`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `setup/route.ts`, `ceo/report/route.ts`, `getLeads`, `import-leads/crm.ts`, `ai-company/page.tsx`, `cashflow/route.ts`, `payments/[id]/route.ts`, `SalesDashboard.tsx`, `vk-ads/campaigns/route.ts`, `vk-ads/sync/route.ts`, `partners/db.ts`, `sales/data.ts`, `payments/create/route.ts`, `notifications/route.ts`, `finance/api.ts`, `finance/orders/route.ts`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `tender-intelligence/route.ts`, `calculator/submit/route.ts`, `import-leads/leads/route.ts`, `ai-funnel/submit/route.ts`, `pricing-engine.ts`, `api/leads/route.ts`, `vk-ads/sync/route.ts`, `import-leads/crm.ts`, `market-intelligence/db.ts`, `getDb`?**
