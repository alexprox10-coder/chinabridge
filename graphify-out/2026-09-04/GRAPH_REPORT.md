# Graph Report - chinabridge  (2026-09-04)

## Corpus Check
- 750 files · ~1,013,230 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4333 nodes · 8113 edges · 302 communities (248 shown, 54 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e36d30a6`
...
- SignupForm.tsx
- finance/orders/route.ts
- getDb
- checks/telegram.ts
- rates/sync/route.ts
- tochka-webhook/route.ts
- CeoReportWidget.tsx
...
- OnboardingSteps.tsx
- kaspi-china/layout.tsx
- reset-rate-limit.mjs
...
- [id]/offer/route.ts
- rate-routes/route.ts
- install.sh
- rate-services/route.ts
- rates/route.ts
...
2. `AdminNav()` - 59 edges
3. `getDb()` - 38 edges
4. `createLead()` - 35 edges
5. `getTenantId()` - 35 edges
6. `getSession()` - 34 edges
7. `getLLMConfig()` - 28 edges
8. `getLeads()` - 23 edges
9. `bootstrap()` - 21 edges
10. `getSql()` - 21 edges
...
## Communities (302 total, 54 thin omitted)
...
Cohesion: 0.07
Nodes (48): DEAL_STATUS_COLOR, DEAL_STATUS_LABEL, DirectorTab(), DOC_STATUS_COLOR, DOC_STATUS_LABEL, DOC_TYPE_LABEL, OperationsDashboard(), OverviewTab() (+40 more)
...
### Community 9 - "NicheLeadPage.tsx"
Cohesion: 0.11
Nodes (10): metadata, metadata, metadata, metadata, metadata, metadata, metadata, NicheConfig (+2 more)

### Community 10 - "supplier-wildberries-china/page.tsx"
Cohesion: 0.33
...
### Community 12 - "SeoClustersClient.tsx"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (23): RateBenchmark, revalidate, runtime, DELETE(), runtime, DELETE(), runtime, DELETE() (+15 more)
...
Cohesion: 0.05
Nodes (48): dynamic, GET(), runtime, dynamic, GET(), runtime, dynamic, GET() (+40 more)

### Community 22 - "payments/create/route.ts"
Cohesion: 0.13
Nodes (22): maxDuration, POST(), runtime, GET(), maxDuration, runtime, maxDuration, POST() (+14 more)

### Community 23 - "AdminNav.tsx"
Cohesion: 0.10
Nodes (14): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, buildUtm(), Campaign, CampaignsPage(), CHANNEL_ICONS (+6 more)
...
Cohesion: 0.23
Nodes (18): dynamic, MarketIntelligencePage(), dynamic, GET(), getTenantId(), POST(), runtime, ensureMISchema() (+10 more)
...
Cohesion: 0.22
Nodes (15): getSeedRates(), SeedRate, SEED_ROUTES, SeedRoute, err(), loadEnv(), log(), main() (+7 more)
...
Cohesion: 0.10
Nodes (21): BLANK, CARGO_TYPES, CURRENCIES, RATE_TYPES, SOURCE_BADGE, TRANSPORT_TYPES, BLANK, TRANSPORT_TYPES (+13 more)

### Community 34 - "calculator/route.ts"
Cohesion: 0.43
Nodes (6): CITY_COUNTRIES, fmtDays(), getAIRec(), POST(), runtime, saveClientCalculation()

### Community 35 - "rate-calculator.ts"
Cohesion: 0.19
Nodes (18): POST(), runtime, applyRules(), calcBaseCost(), calcServiceCost(), calculateDeliveryCost(), computeChargeableWeight(), saveCalculation() (+10 more)
...
Cohesion: 0.10
Nodes (13): ClientThread, CITIES, CreateOrderForm(), ClientAccount, ClientDocument, ClientMessage, ClientOrder, ORDER_STATUS_COLORS (+5 more)

### Community 38 - "app/services/page.tsx"
Cohesion: 0.10
Nodes (17): CITIES, metadata, FAQ, metadata, schema, FAQ, metadata, schema (+9 more)

### Community 39 - "getLeads"
Cohesion: 0.13
Nodes (21): DashboardPage(), auth(), ensureTable(), GET(), POST(), DELETE(), dynamic, GET() (+13 more)
...
### Community 46 - "trackGAEvent"
Cohesion: 0.12
Nodes (16): GAInner(), DirectionsSplit(), Hero(), HowItWorks(), STEPS, ImportEcosystemBlock(), partnerCards, stages (+8 more)

### Community 47 - "ai-funnel/submit/route.ts"
Cohesion: 0.16
...
Cohesion: 0.09
Nodes (23): AIEconomicsFunnel(), ANALYZE_STAGES, ANON_LIMIT, CITY_CHIPS, CorrectionData, EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice() (+15 more)

### Community 51 - "SalesDashboard.tsx"
Cohesion: 0.08
...
### Community 53 - "getTenantId"
Cohesion: 0.13
Nodes (21): dynamic, GET(), POST(), runtime, dynamic, GET(), PATCH(), runtime (+13 more)
...
Cohesion: 0.17
Nodes (17): dynamic, notifyManagerTelegram(), POST(), REQUIRED, REQUIRES_PHONE, runtime, validate(), LeadData (+9 more)

### Community 56 - "lead-finder/index.ts"
Cohesion: 0.20
Nodes (18): POST(), aiScore(), Contacts, dedup(), extractContacts(), firecrawlSearch(), GOOGLE_QUERIES, heuristic() (+10 more)

### Community 57 - "ai/types.ts"
Cohesion: 0.12
Nodes (16): AgentBadge(), CONFIG, ChatInput(), Props, ChatMessage(), Props, ChatWidget, Message (+8 more)

### Community 58 - "rate-rules/route.ts"
Cohesion: 0.50
Nodes (3): POST(), runtime, validatePricingRule()

### Community 59 - "AnalyticsProvider.tsx"
Cohesion: 0.17
Nodes (7): inter, metadata, orgSchema, trackVkGoal(), VkPixel(), alertManager(), FloatingContact()

### Community 60 - "client-portal/auth.ts"
Cohesion: 0.21
Nodes (16): GET(), notifyAdmin(), runtime, setSessionCookie(), ipAttempts, notifyAdmin(), POST(), runtime (+8 more)
...
### Community 63 - "vk-intent/pipeline.ts"
Cohesion: 0.05
Nodes (65): dynamic, GET(), maxDuration, runtime, GET(), DELETE(), dynamic, GET() (+57 more)

### Community 64 - "intelligence/client.ts"
Cohesion: 0.13
Nodes (18): CreateMarketWatchInput, FactSnapshot, MarketWatchItem, SQL, ChangeStatus, ChangeType, Confidence, CrawlFrequency (+10 more)

### Community 65 - "vk-scraper/route.ts"
Cohesion: 0.23
Nodes (12): classifyIntent(), dynamic, GET(), INTENT_KEYWORDS, maxDuration, notifyManager(), resolveGroupId(), runtime (+4 more)

### Community 66 - "multitenant/types.ts"
Cohesion: 0.08
Nodes (27): BillingClient(), Plan, PLAN_BTN, PLAN_COLOR, BillingPage(), dynamic, dynamic, TenantPage() (+19 more)

### Community 67 - "getSession"
Cohesion: 0.18
Nodes (16): GET(), runtime, GET(), runtime, POST(), runtime, DocumentsPage(), OrderDetailPage() (+8 more)

### Community 68 - "CurrencyRates.tsx"
Cohesion: 0.32
Nodes (7): CbrResponse, CbrValute, CurrencyRates(), fetchRates(), fmt(), Rates, STATIC_RATES

### Community 69 - "tender-intelligence/route.ts"
Cohesion: 0.08
Nodes (62): authOk(), maxDuration, POST(), runtime, dynamic, GET(), PATCH(), authOk() (+54 more)
...
### Community 77 - "calculator.ts"
Cohesion: 0.33
Nodes (9): buildScenario(), calculateUnitEconomics(), computeProductScore(), computeSupplierRisk(), computeTargetPrice(), EconomicsInput, EconomicsOutput, calcMarketplaceLogisticsPerUnit() (+1 more)

### Community 78 - "eis_collector_beget.py"
Cohesion: 0.33
Nodes (11): ftp_download(), ftp_list(), load_state(), main(), _num(), parse_xml(), post_batch(), relevant() (+3 more)

### Community 79 - "enrich.ts"
Cohesion: 0.22
...
### Community 82 - "eis_collector.py"
Cohesion: 0.18
Nodes (18): download_ftp_file(), is_china_relevant(), list_ftp_files(), load_state(), parse_contract_xml(), Скачивает файл с FTP в dest., Парсит XML-выгрузку контрактов ЕИС, возвращает нормализованные тендеры., Быстрый фильтр до отправки на AI — экономим кредиты. (+10 more)
...
### Community 84 - "notifications/route.ts"
Cohesion: 0.50
...
### Community 86 - "PersonalOfferWidget.tsx"
Cohesion: 0.18
Nodes (8): AnalysisSummary, AttackPlan, CockpitResult, ContactsFound, LOADING_STEPS, OfferOption, PersonalOfferWidget(), ScoreFactor

### Community 87 - "getSql"
Cohesion: 0.18
Nodes (15): dynamic, PATCH(), runtime, dynamic, GET(), POST(), runtime, applyChange() (+7 more)

### Community 88 - "collect/route.ts"
Cohesion: 0.29
Nodes (7): CollectSource, dynamic, extractCommissionWithAI(), maxDuration, POST(), runtime, SOURCE_CONFIG

### Community 89 - "sources/route.ts"
Cohesion: 0.38
Nodes (6): dynamic, GET(), POST(), runtime, createSource(), getSources()

### Community 90 - "finance/api.ts"
Cohesion: 0.07
Nodes (40): dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, FinanceSettingsPage(), dynamic, GET(), POST() (+32 more)

### Community 91 - "outreach-leads/page.tsx"
Cohesion: 0.18
...
### Community 93 - "ai-calculator/page.tsx"
Cohesion: 0.19
Nodes (4): DynamicFunnel, DynamicSideBanners, jsonLd, metadata

### Community 94 - "generator.ts"
Cohesion: 0.10
Nodes (28): POST(), runtime, dynamic, GET(), runtime, dynamic, GET(), runtime (+20 more)

### Community 95 - "memory.ts"
Cohesion: 0.23
Nodes (15): dynamic, POST(), runtime, AGENT_LABELS, addMessage(), doHandoff(), ensureTable(), fallback (+7 more)
...
### Community 104 - "pricing-engine.ts"
Cohesion: 0.24
Nodes (13): calculateCostBreakdown(), CostEngineInput, buildReason(), ruleMatchesInput(), selectPricingRule(), CostBreakdown, PricingSelection, PricingSelectorInput (+5 more)
...
### Community 106 - "analytics/index.ts"
Cohesion: 0.18
Nodes (10): YandexMetrika(), Cases, Services, analytics, CATEGORY_MAP, fire(), METRIKA_ID, reachGoal() (+2 more)
...
### Community 111 - "ensureIntelligenceSchema"
Cohesion: 0.24
Nodes (13): dynamic, GET(), PATCH(), runtime, POST(), dynamic, GET(), runtime (+5 more)

### Community 112 - "AuditClient.tsx"
Cohesion: 0.20
Nodes (6): AuditClient(), AuditResult, Insight, MARKETPLACE_LABEL, STEPS, metadata

### Community 113 - "Header.tsx"
Cohesion: 0.14
Nodes (13): FulfilmentClient(), MARKETS, SERVICES, STEPS, WAREHOUSES, metadata, generateMetadata(), getPage() (+5 more)

### Community 114 - "deal-intelligence/index.ts"
Cohesion: 0.12
Nodes (13): ALERT_COLORS, DealIntelligenceClient(), RISK_COLORS, dynamic, analyzeDealIntelligence(), calcForecast(), scoreDeal(), STATUS_BASE (+5 more)

### Community 115 - "ai-company/page.tsx"
Cohesion: 0.23
...
### Community 118 - "product-finder/page.tsx"
Cohesion: 0.28
Nodes (6): metadata, EXAMPLES, fmt(), Product, ProductFinderUI(), SearchResult

### Community 120 - "ImportLead"
Cohesion: 0.10
Nodes (19): IMPORTS_LABELS, Props, SCORE_COLORS, STATUS_LABELS, STATUS_STYLES, ACTION_ICON, AiSalesAgentClient(), Recommendation (+11 more)

### Community 121 - "articles/route.ts"
Cohesion: 0.27
Nodes (5): runtime, runtime, Article, ARTICLE_CATEGORIES, ARTICLES

### Community 122 - "market-intelligence/types.ts"
Cohesion: 0.11
Nodes (15): PIPE_COLORS, SOURCE_ICON, Tab, TEMP_COLORS, dynamic, DEMO_SIGNALS, RadarClient(), Tab (+7 more)

### Community 123 - "presentation/page.tsx"
Cohesion: 0.22
Nodes (7): AUDIENCE, FEATURES, FORMATS, metadata, PROBLEMS, WHY, PrintButton()

### Community 124 - "VkAdsDashboard.tsx"
Cohesion: 0.29
Nodes (5): AccountData, Campaign, LeadData, LeadForm, VkAdsDashboard()

### Community 125 - "economics/route.ts"
Cohesion: 0.24
...
Cohesion: 0.15
Nodes (12): 1. Intel_facts: seed WB/Ozon/Kaspi commissions, 2. AI Product Analyzer → Lead capture, 3. CLAUDE.md structure (this task) ✅ In progress, 4. VK Pixel, 5. AI Sales Agent v1 — Architecture, 6. Intel_facts: CNY/USD auto-collector, Done This Week, P0 — Must ship this week (+4 more)

### Community 127 - "CHINABRIDGE — AI OPERATING SYSTEM"
Cohesion: 0.17
Nodes (11): AI AGENT RULES, CHINABRIDGE — AI OPERATING SYSTEM, CODE RULES, COMPLIANCE (IMMUTABLE), DATA RULES, graphify, INTELLIGENCE PIPELINE, MARKETING RULES (+3 more)
...
### Community 134 - "Russia Import Rules"
Cohesion: 0.17
...
### Community 135 - "payments/route.ts"
Cohesion: 0.27
Nodes (9): FinanceDashboardPage(), dynamic, GET(), POST(), runtime, createPayment(), getAllPayments(), getPaymentsByLead() (+1 more)
...
### Community 137 - "client-portal/api.ts"
Cohesion: 0.13
Nodes (23): AdminCalculationsPage(), dynamic, fmtDate(), revalidate, TRANSPORT_LABELS, dynamic, GET(), POST() (+15 more)

### Community 138 - "SalesCompaniesClient.tsx"
Cohesion: 0.18
...
Cohesion: 0.50
Nodes (4): dynamic, POST(), runtime, sendTelegram()

### Community 140 - "setup/route.ts"
Cohesion: 0.23
Nodes (12): dynamic, POST(), runtime, dynamic, maxDuration, POST(), runtime, DEMO_LEADS (+4 more)

### Community 141 - "proposals/page.tsx"
Cohesion: 0.25
Nodes (8): dynamic, MODE_COLORS, ProposalsPage(), revalidate, STATUS_COLORS, STATUS_LABELS, getProposals(), ProposalStatus

### Community 142 - "clusters.ts"
Cohesion: 0.16
Nodes (15): auth(), GET(), getDynamicKeywords(), POST(), ensureTable(), GET(), POST(), Competition (+7 more)

### Community 143 - "chat/page.tsx"
Cohesion: 0.29
...
### Community 146 - "finance/orders/route.ts"
Cohesion: 0.36
Nodes (7): dynamic, GET(), POST(), runtime, FinanceTab(), createFinanceOrder(), calcFinancials()

### Community 147 - "getDb"
Cohesion: 0.13
Nodes (24): GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration, POST(), runtime (+16 more)

### Community 148 - "checks/telegram.ts"
Cohesion: 0.36
...
### Community 150 - "tochka-webhook/route.ts"
Cohesion: 0.22
Nodes (13): dynamic, ensureLinksTable(), POST(), runtime, sql, DELETE(), GET(), isSuperAdmin() (+5 more)

### Community 151 - "CeoReportWidget.tsx"
Cohesion: 0.20
Nodes (9): Alert, ALERT_STYLE, CeoReport, CeoReportWidget(), Insight, Priority, Stats, TREND_COLOR (+1 more)

### Community 152 - "client/dashboard/page.tsx"
Cohesion: 0.17
Nodes (13): GET(), runtime, DashboardPage(), getCalcSubscription(), OrdersPage(), CURRENCY_SYMBOLS, formatAmount(), PAYMENT_STATUS_LABELS (+5 more)
...
### Community 155 - "facts/route.ts"
Cohesion: 0.40
Nodes (5): dynamic, GET(), POST(), runtime, getFacts()

### Community 156 - "demo/documents/page.tsx"
Cohesion: 0.29
Nodes (5): DOC_TYPES, DOCS, STATUS_LABEL, STATUS_STYLE, TYPE_COLORS

### Community 157 - "signup/route.ts"
Cohesion: 0.20
...
### Community 160 - "wildberries-margin-calculator/page.tsx"
Cohesion: 0.22
...
### Community 162 - "tochka/route.ts"
Cohesion: 0.50
Nodes (7): ensureLinksTable(), GET(), getSql(), maxDuration, POST(), requireAdmin(), runtime

### Community 163 - "apify-leads/route.ts"
Cohesion: 0.47
Nodes (5): dynamic, isAuthorized(), POST(), runtime, scoreFromReviews()

### Community 164 - "lid-webhook/route.ts"
Cohesion: 0.21
Nodes (12): DRIP, dynamic, GET(), runtime, sendTg(), answerCallback(), dynamic, ensureBridgeTables() (+4 more)
...
### Community 171 - "import-leads/crm.ts"
Cohesion: 0.10
Nodes (29): analyzeLeadsWithAI(), GET(), isAuthorized(), LeadRecommendation, maxDuration, POST(), runtime, GET() (+21 more)
...
### Community 180 - "vk-ads/sync/route.ts"
Cohesion: 0.24
...
### Community 182 - "Intelligence Agent — Context"
Cohesion: 0.22
Nodes (8): API Endpoints, Collection Pipeline, Current Status (as of 2026-08-20), Data it owns, Intelligence Agent — Context, P0 Tasks, Purpose, Rules for Writing to intel_facts
...
### Community 186 - "Sales Agent System Prompt"
Cohesion: 0.22
Nodes (8): Before Writing Any Message, Compliance, Example Bad Opening (never do this), Example Good Opening (KZ), Message Structure, Output Format, Sales Agent System Prompt, Your Role

### Community 187 - "clients/route.ts"
Cohesion: 0.23
Nodes (12): DELETE(), dynamic, GET(), isAdmin(), runtime, GET(), PATCH(), runtime (+4 more)

### Community 189 - "marketing-ai/route.ts"
Cohesion: 0.50
Nodes (4): buildSystemPrompt(), maxDuration, POST(), runtime

### Community 191 - "Footer.tsx"
Cohesion: 0.12
Nodes (10): metadata, jsonLd, metadata, FAQ, metadata, companyLinks, importLinks, navLinks (+2 more)

### Community 192 - "init/route.ts"
Cohesion: 0.28
Nodes (7): dynamic, GET(), maxDuration, runtime, SEED_FACTS, SEED_SOURCES, CreateFactInput

### Community 193 - "demo/finance/page.tsx"
Cohesion: 0.40
Nodes (3): CATEGORIES, MONTHS, TRANSACTIONS

### Community 194 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
Nodes (7): GET(), getToken(), maxDuration, POST(), runtime, vkGet(), vkPost()

### Community 195 - "Kazakhstan Import Rules"
Cohesion: 0.22
Nodes (8): ⚠️ CRITICAL COMPLIANCE RULE, Grey Scheme Mechanics (for internal context only — never for client-facing copy), Kaspi.kz — Key Platform, Kazakhstan Import Rules, Key Cities and Transit Times, Lead Source Context, Pricing Context, Proposal Template for KZ Clients
...
Cohesion: 0.25
Nodes (7): Compliance (same as sales), Customer Success Agent — Context, Data It Reads, Message Tone, Purpose, Triggers for Outreach, What to Track

### Community 206 - "demo-request/route.ts"
Cohesion: 0.67
Nodes (3): escapeNonAscii(), POST(), runtime

### Community 245 - "ai-funnel/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, GET(), isAuthorized(), runtime

### Community 246 - "Sales Agent — Context"
Cohesion: 0.25
Nodes (7): How This Agent Works, Message Rules, Purpose, Qualification Scoring, Sales Agent — Context, System Prompt, Tools Available

### Community 247 - "SEO Agent — Context"
Cohesion: 0.25
...
### Community 251 - "checks/api.ts"
Cohesion: 0.40
Nodes (5): AUTH, checkApi(), fetchRoute(), ROUTES, RouteSpec

### Community 252 - "seo.ts"
Cohesion: 0.60
Nodes (5): check404(), checkHomepageMeta(), checkRobots(), checkSeo(), checkSitemap()

### Community 253 - "cbr/route.ts"
Cohesion: 0.33
Nodes (5): dynamic, fetchCbrRates(), maxDuration, POST(), runtime

### Community 254 - "Marketplace Commission Rules"
Cohesion: 0.29
...
Cohesion: 0.50
Nodes (3): ChinaBridge — Business Knowledge, Files in this directory, How to use this knowledge

### Community 262 - "AdminNav"
Cohesion: 0.08
Nodes (38): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, FinanceOrdersPage(), fmtDate(), revalidate (+30 more)

### Community 263 - "currency/route.ts"
Cohesion: 0.33
Nodes (6): CbrValute, fetchCbrRates(), GET(), RatesResult, revalidate, runtime

### Community 264 - "FAQSection.tsx"
Cohesion: 0.12
...
### Community 267 - "LeadMagnetForm.tsx"
Cohesion: 0.22
Nodes (6): benefits, faqs, jsonLd, metadata, FormState, LeadMagnetForm()

### Community 268 - "telegram-capture/route.ts"
Cohesion: 0.83
Nodes (3): ensureTable(), notifyManager(), POST()

### Community 269 - "import-audit/page.tsx"
Cohesion: 0.20
Nodes (9): AUDIT_POINTS, jsonLd, metadata, Footer(), cls(), ImportAuditForm(), PROBLEMS, Step (+1 more)

### Community 270 - "OnboardingSteps.tsx"
Cohesion: 0.40
Nodes (3): Props, Step, STEPS

### Community 273 - "reset-rate-limit.mjs"
Cohesion: 0.50
Nodes (3): dbUrl, envContent, sql

### Community 277 - "crm/client.ts"
Cohesion: 0.10
Nodes (29): dynamic, LeadPage(), revalidate, DELETE(), dynamic, GET(), PATCH(), runtime (+21 more)

### Community 278 - "supplier-finder/route.ts"
Cohesion: 0.47
Nodes (5): checkLimit(), getIp(), maxDuration, POST(), runtime

### Community 279 - "import-leads/status-store.ts"
Cohesion: 0.57
Nodes (7): deleteLeadPermanently(), ensureTable(), getDeletedLeadIds(), getLeadStatuses(), markLeadDeleted(), setLeadStatus(), sql

### Community 280 - "support-webhook/route.ts"
Cohesion: 0.40
Nodes (5): dynamic, GREETING_BUTTONS, POST(), runtime, sendViaSupport()

### Community 281 - "company-enrich/route.ts"
Cohesion: 0.27
Nodes (7): ContactInfo, dynamic, EgrulRaw, extractText(), fetchEgrul(), fetchRusprofile(), GET()

### Community 282 - "integrations/page.tsx"
Cohesion: 0.40
Nodes (3): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus

### Community 284 - "[id]/offer/route.ts"
Cohesion: 0.29
Nodes (10): dynamic, ensureAiColumns(), extractContacts(), fetchPage(), GET(), htmlToText(), POST(), runtime (+2 more)

### Community 285 - "rate-routes/route.ts"
Cohesion: 0.50
Nodes (3): POST(), runtime, validateRoute()

### Community 287 - "rate-services/route.ts"
Cohesion: 0.50
Nodes (3): POST(), runtime, validateService()

### Community 288 - "rates/route.ts"
Cohesion: 0.50
...
### Community 291 - "b2bchina-alternative/page.tsx"
Cohesion: 0.40
Nodes (3): competitors, jsonLd, metadata

### Community 292 - "TochkaLinksSection.tsx"
Cohesion: 0.38
Nodes (6): fmtAmount(), fmtDate(), PaymentLink, STATUS_LABEL, STATUS_STYLE, TochkaLinksSection()

### Community 293 - "calculator-lead/route.ts"
Cohesion: 0.47
Nodes (5): dynamic, ensureTable(), fmtNum(), POST(), runtime

### Community 294 - "china-delivery/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 295 - "inspection/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 296 - "marketing/partners/page.tsx"
Cohesion: 0.33
Nodes (4): Partner, PLATFORMS, STATUS_COLORS, STATUSES

### Community 298 - "registrations/page.tsx"
Cohesion: 0.47
Nodes (5): Client, COUNTRY_FLAG, daysSince(), fmt(), RegistrationsPage()

### Community 299 - "payments/[id]/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, PATCH(), runtime, updatePayment()

### Community 300 - "app/partners/page.tsx"
Cohesion: 0.40
Nodes (3): FAQS, metadata, STEPS

### Community 301 - "fonts.ts"
Cohesion: 0.70
Nodes (3): ROBOTO_BOLD_B64, ROBOTO_LIGHT_B64, ROBOTO_REGULAR_B64

## Knowledge Gaps
- **1386 isolated node(s):** `NicheConfig`, `ExtractedPost`, `AnalyticsRow`, `CrmStats`, `DemoChannel` (+1381 more)
...
- **Why does `AdminNav()` connect `AdminNav` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `SalesCompaniesClient.tsx`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `proposals/page.tsx`, `chat/page.tsx`, `LeadDetail.tsx`, `pricing/page.tsx`, `crm/client.ts`, `AdminNav.tsx`, `CeoDashboard.tsx`, `market-intelligence/db.ts`, `integrations/page.tsx`, `intelligence/page.tsx`, `rate-engine/types.ts`, `client-portal/types.ts`, `marketing/partners/page.tsx`, `VkIntentClient.tsx`, `registrations/page.tsx`, `TgMonitorClient.tsx`, `MarketingPageClient.tsx`, `SalesDashboard.tsx`, `multitenant/types.ts`, `tenders/page.tsx`, `PlatformDashboard.tsx`, `CreateWizard.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `finance/api.ts`, `outreach-leads/page.tsx`, `WbSellersClient.tsx`, `HhLeadsClient.tsx`, `deal-intelligence/index.ts`, `ai-company/page.tsx`, `ImportLead`, `market-intelligence/types.ts`, `VkAdsDashboard.tsx`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `apify-leads/route.ts`, `tender-intelligence/route.ts`, `getLeads`, `market-intelligence/leads/route.ts`, `ai-funnel/submit/route.ts`, `getDb`, `vk-ads/sync/route.ts`, `getTenantId`, `api/leads/route.ts`, `ImportLead`, `economics/route.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `AdminNav`, `payments/route.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `setup/route.ts`, `ceo/report/route.ts`, `finance/orders/route.ts`, `payments/create/route.ts`, `supplier-finder/route.ts`, `getLeads`, `payments/[id]/route.ts`, `sales/data.ts`, `SalesDashboard.tsx`, `vk-ads/sync/route.ts`, `getTenantId`, `partners/db.ts`, `vk-ads/campaigns/route.ts`, `notifications/route.ts`, `finance/api.ts`, `ai-company/page.tsx`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **What connects `NicheConfig`, `ExtractedPost`, `AnalyticsRow` to the rest of the system?**
