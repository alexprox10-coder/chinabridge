# Graph Report - chinabridge  (2026-08-17)

## Corpus Check
- 619 files · ~924,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3519 nodes · 6842 edges · 229 communities (191 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc45f117`
...
Cohesion: 0.10
Nodes (30): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, FinanceOrdersPage(), fmtDate(), revalidate (+22 more)

### Community 12 - "multitenant/types.ts"
Cohesion: 0.12
Nodes (20): COUNTRY_FLAG, fmtMoney(), PLAN_BADGE, PlatformDashboard(), STATUS_DOT, COUNTRY_FLAG, PLAN_BADGE, buildAiContext() (+12 more)

### Community 13 - "clusters.ts"
Cohesion: 0.16
...
Cohesion: 0.08
Nodes (24): jsonLd, metadata, metadata, metadata, FAQS, metadata, STEPS, metadata (+16 more)

### Community 16 - "admin/dashboard/page.tsx"
Cohesion: 0.15
Nodes (14): dynamic, revalidate, ALL_STATUSES, COLUMNS, LeadCard(), msAgo(), timeLabel(), CRMLead (+6 more)
...
Cohesion: 0.08
Nodes (35): dynamic, isAuthorized(), POST(), runtime, scoreFromReviews(), DELETE(), dynamic, GET() (+27 more)
...
### Community 21 - "proposals/create/route.ts"
Cohesion: 0.20
Nodes (11): POST(), runtime, dynamic, GET(), runtime, dynamic, GET(), runtime (+3 more)

### Community 22 - "analytics/index.ts"
Cohesion: 0.17
Nodes (10): inter, metadata, GoogleAnalytics(), MicrosoftClarity(), YandexMetrika(), fire(), METRIKA_ID, reachGoal() (+2 more)
...
### Community 54 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
...
### Community 56 - "signup/route.ts"
Cohesion: 0.17
Nodes (17): POST(), runtime, POST(), runtime, maxDuration, POST(), runtime, createSessionToken() (+9 more)

### Community 57 - "getAllLeads"
Cohesion: 0.15
Nodes (17): GET(), isAuthorized(), maxDuration, OfferResult, runtime, selectOffer(), fallbackTasks(), GET() (+9 more)

### Community 58 - "import-leads/crm.ts"
Cohesion: 0.24
...
### Community 79 - "admin/leads/route.ts"
Cohesion: 0.16
Nodes (18): DELETE(), dynamic, GET(), POST(), runtime, dynamic, POST(), runtime (+10 more)

### Community 80 - "marketing/partners/page.tsx"
Cohesion: 0.17
Nodes (7): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus, Partner, PLATFORMS, STATUS_COLORS, STATUSES

### Community 81 - "tenants/route.ts"
Cohesion: 0.24
...
### Community 83 - "admin/settings/billing/page.tsx"
Cohesion: 0.31
...
Cohesion: 0.24
Nodes (10): buildScenario(), calculateUnitEconomics(), computeProductScore(), computeSupplierRisk(), computeTargetPrice(), EconomicsInput, EconomicsOutput, calcMarketplaceLogisticsPerUnit() (+2 more)
...
### Community 89 - "finance/api.ts"
Cohesion: 0.13
Nodes (21): dynamic, FinanceSettingsPage(), revalidate, dynamic, GET(), PUT(), runtime, FinanceSettingsForm() (+13 more)

### Community 90 - "orders/pdf/route.ts"
Cohesion: 0.31
Nodes (8): dynamic, FinancePDF(), GET(), runtime, s, getExpensesByLead(), getFinanceOrderByLead(), rowToOrder()
...
### Community 106 - "CeoReportWidget.tsx"
Cohesion: 0.20
Nodes (9): Alert, ALERT_STYLE, CeoReport, CeoReportWidget(), Insight, Priority, Stats, TREND_COLOR (+1 more)

### Community 107 - "LeadDetail.tsx"
Cohesion: 0.09
Nodes (16): dynamic, LeadPage(), revalidate, AiSummary, ALL_PRIORITIES, ALL_STATUSES, LeadDetail(), MainTab (+8 more)

### Community 108 - "articles/route.ts"
Cohesion: 0.27
Nodes (5): runtime, runtime, Article, ARTICLE_CATEGORIES, ARTICLES

### Community 109 - "seed-db.ts"
Cohesion: 0.36
...
### Community 113 - "ChinaBridge — Библиотека промптов для Apify"
Cohesion: 0.18
Nodes (10): ChinaBridge — Библиотека промптов для Apify, ПРОМПТ 1 — Продавцы Wildberries (активные), ПРОМПТ 2 — Оптовые магазины Алматы (Google Maps), ПРОМПТ 3 — Строительные компании Казахстан, ПРОМПТ 4 — Магазины электроники Россия (приграничные города), ПРОМПТ 5 — Продавцы Ozon (товары для дома), ПРОМПТ 6 — Автозапчасти оптом (Казахстан + Россия), ПРОМПТ 7 — Instagram аудитория конкурентов (+2 more)

### Community 114 - "outreach-leads/page.tsx"
Cohesion: 0.18
Nodes (11): APIFY_PRESETS, ApifyLead, DORK_TEMPLATES, EMPTY_LEAD, EMPTY_WB, Lead, OutreachLeadsPage(), useWorkflowRunner() (+3 more)

### Community 115 - "getDb"
Cohesion: 0.12
Nodes (23): FinanceDashboardPage(), dynamic, GET(), POST(), runtime, dynamic, GET(), POST() (+15 more)

### Community 116 - "AdminNav.tsx"
Cohesion: 0.08
Nodes (15): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, DealIntelligenceClient(), dynamic, dynamic, RadarClient() (+7 more)
...
### Community 118 - "SalesCompaniesClient.tsx"
Cohesion: 0.18
...
### Community 124 - "market-intelligence/leads/route.ts"
Cohesion: 0.13
Nodes (14): PIPE_COLORS, SOURCE_ICON, Tab, TEMP_COLORS, buildMIComment(), dynamic, GET(), getTenantId() (+6 more)

### Community 125 - "ChinaBridge — Еженедельный отчёт по лидам"
Cohesion: 0.22
Nodes (8): ChinaBridge — Еженедельный отчёт по лидам, План на следующую неделю, По городам, По источникам, Сводка, Топ ответы (потенциальные клиенты), Что не сработало, Что сработало на этой неделе

### Community 126 - "getSession"
Cohesion: 0.31
Nodes (12): GET(), runtime, GET(), runtime, DocumentsPage(), OrderDetailPage(), dtQuery(), getClientDocuments() (+4 more)

### Community 127 - "fonts.ts"
Cohesion: 0.70
...
### Community 131 - "store.ts"
Cohesion: 0.14
Nodes (20): DELETE(), GET(), isSuperAdmin(), maxDuration, PATCH(), runtime, tenants, tenantSettings (+12 more)
...
### Community 133 - "getLLMConfig"
Cohesion: 0.12
Nodes (19): ensureTable(), GET(), POST(), isAuthorized(), maxDuration, POST(), runtime, fallbackOffer() (+11 more)

### Community 134 - "ChinaBridge — Шаблоны холодных сообщений"
Cohesion: 0.25
Nodes (7): ChinaBridge — Шаблоны холодных сообщений, Инструкция по персонализации, ШАБЛОН 1 — Для продавцов WB / Ozon, ШАБЛОН 2 — Для оптовиков Казахстана, ШАБЛОН 3 — Для строительных компаний, ШАБЛОН 4 — Для магазинов электроники, ШАБЛОН 5 — Для автозапчастей
...
### Community 138 - "telegram/webhook/route.ts"
Cohesion: 0.27
...
### Community 153 - "tenants/[id]/page.tsx"
Cohesion: 0.33
...
### Community 156 - "marketplace-rates/route.ts"
Cohesion: 0.33
...
### Community 159 - "finance/orders/[id]/route.ts"
Cohesion: 0.43
...
### Community 162 - "rates/sync/route.ts"
Cohesion: 0.43
Nodes (6): dynamic, fetchCBRRates(), GET(), POST(), runtime, upsertRate()

### Community 163 - "ai-funnel/submit/route.ts"
Cohesion: 0.43
...
### Community 165 - "calculator/route.ts"
Cohesion: 0.43
...
### Community 169 - "import-leads/leads/route.ts"
Cohesion: 0.48
...
### Community 172 - "expenses/[id]/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, PATCH(), runtime, updateExpense()

### Community 174 - "payments/[id]/route.ts"
Cohesion: 0.50
...
### Community 221 - "notifications/route.ts"
Cohesion: 0.38
Nodes (5): GET(), maxDuration, runtime, generateNotifications(), CeoNotification

### Community 222 - "hh-leads/route.ts"
Cohesion: 0.60
Nodes (4): GET(), isAuthorized(), POST(), runtime

### Community 223 - "wb-sellers/route.ts"
Cohesion: 0.60
Nodes (4): GET(), isAuthorized(), POST(), runtime

### Community 225 - "china-blagoveshchensk/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 226 - "china-spb/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 227 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

## Knowledge Gaps
- **1084 isolated node(s):** `runtime`, `dynamic`, `runtime`, `dynamic`, `ExtractedPost` (+1079 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `admin/calculations/page.tsx`, `ContentPageClient.tsx`, `lib/finance/types.ts`, `VkAdsDashboard.tsx`, `chat/page.tsx`, `admin/dashboard/page.tsx`, `CeoDashboard.tsx`, `tenants/[id]/page.tsx`, `SalesDashboard.tsx`, `rate-engine/types.ts`, `pricing/page.tsx`, `MarketingPageClient.tsx`, `reports/page.tsx`, `ImportLead`, `market-intelligence/db.ts`, `CreateWizard.tsx`, `SeoClustersClient.tsx`, `ai-cto/db.ts`, `marketing/partners/page.tsx`, `admin/settings/billing/page.tsx`, `proposals/page.tsx`, `ai-company/page.tsx`, `finance/api.ts`, `WbSellersClient.tsx`, `HhLeadsClient.tsx`, `SalesDashboardClient.tsx`, `LeadDetail.tsx`, `campaigns/page.tsx`, `outreach-leads/page.tsx`, `SalesCompaniesClient.tsx`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `ai-funnel/submit/route.ts`, `import-leads/leads/route.ts`, `admin/leads/route.ts`, `getDb`, `sync/route.ts`, `api/leads/route.ts`, `market-intelligence/leads/route.ts`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `ceo/report/route.ts`, `product-finder/route.ts`, `SalesDashboard.tsx`, `client-portal/api.ts`, `check/route.ts`, `sales/data.ts`, `reports/page.tsx`, `vk-ads/campaigns/route.ts`, `partners/db.ts`, `payments/create/route.ts`, `admin/leads/route.ts`, `sync/route.ts`, `ai-company/page.tsx`, `notifications/route.ts`?**
