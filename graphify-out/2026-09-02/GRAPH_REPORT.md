...
## Corpus Check
- 749 files · ~1,012,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4325 nodes · 8099 edges · 289 communities (236 shown, 53 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a40f38f7`
...
## Communities (289 total, 53 thin omitted)
...
Cohesion: 0.05
Nodes (52): dynamic, GET(), runtime, dynamic, GET(), runtime, dynamic, GET() (+44 more)

### Community 22 - "payments/create/route.ts"
Cohesion: 0.14
Nodes (19): maxDuration, POST(), runtime, maxDuration, POST(), runtime, ensureLinksTable(), GET() (+11 more)

### Community 23 - "AdminNav.tsx"
Cohesion: 0.04
Nodes (38): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, CompanyPanel(), DetailModal(), EnrichResult, PRIORITY_COLOR (+30 more)
...
### Community 53 - "getLeads"
Cohesion: 0.26
Nodes (12): DashboardPage(), auth(), ensureTable(), GET(), POST(), DELETE(), dynamic, GET() (+4 more)
...
Cohesion: 0.09
Nodes (26): BillingClient(), Plan, PLAN_BTN, PLAN_COLOR, BillingPage(), dynamic, AI_LINKS, TenantDetail() (+18 more)
...
### Community 71 - "reports/page.tsx"
Cohesion: 0.15
Nodes (14): dynamic, FinanceOrdersPage(), fmtDate(), revalidate, dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate (+6 more)
...
Cohesion: 0.06
Nodes (56): FinanceDashboardPage(), FinanceSettingsPage(), dynamic, GET(), POST(), runtime, dynamic, GET() (+48 more)
...
Cohesion: 0.13
Nodes (18): AI_STEPS, CalculatorForm(), CITY_CHIPS, initialFormData, inp(), CalculatorFormData, CalculatorResult, CARGO_TYPE_ICONS (+10 more)
...
### Community 104 - "download/[id]/route.ts"
Cohesion: 0.24
Nodes (8): dynamic, GET(), runtime, dynamic, GET(), runtime, CRMLead, getProposal()
...
### Community 124 - "ai-sales-agent/route.ts"
Cohesion: 0.36
...
### Community 135 - "settings/route.ts"
Cohesion: 0.40
Nodes (5): dynamic, GET(), PUT(), runtime, updateSetting()
...
### Community 140 - "getTenantId"
Cohesion: 0.12
Nodes (23): dynamic, GET(), POST(), runtime, dynamic, GET(), POST(), runtime (+15 more)

### Community 141 - "product-finder/route.ts"
Cohesion: 0.47
...
### Community 146 - "expenses/[id]/route.ts"
Cohesion: 0.50
...
### Community 150 - "tenants/[id]/route.ts"
Cohesion: 0.39
...
### Community 157 - "wb-leads/route.ts"
Cohesion: 0.60
...
### Community 162 - "china-blagoveshchensk/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 163 - "china-moscow/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 167 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 168 - "FAQSection.tsx"
Cohesion: 0.09
Nodes (17): FAQ, metadata, schema, FAQ, metadata, schema, FAQ, metadata (+9 more)
...
### Community 171 - "briefing/route.ts"
Cohesion: 0.38
...
Cohesion: 0.07
Nodes (19): competitors, jsonLd, metadata, metadata, jsonLd, metadata, FAQS, metadata (+11 more)
...
Cohesion: 0.09
Nodes (33): dynamic, FinanceExpensesPage(), fmtDate(), revalidate, dynamic, revalidate, dynamic, FinancePaymentsPage() (+25 more)
...
Cohesion: 0.09
Nodes (33): dynamic, LeadPage(), revalidate, dynamic, isAuthorized(), POST(), runtime, scoreFromReviews() (+25 more)
...
Cohesion: 0.13
Nodes (28): GET(), isAuthorized(), POST(), runtime, fallbackTasks(), GET(), isAuthorized(), maxDuration (+20 more)

### Community 280 - "support-webhook/route.ts"
Cohesion: 0.50
Nodes (4): dynamic, POST(), runtime, sendViaSupport()
...
## Knowledge Gaps
- **1381 isolated node(s):** `runtime`, `ExtractedPost`, `AnalyticsRow`, `CrmStats`, `DemoChannel` (+1376 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `lib/finance/types.ts`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `SalesCompaniesClient.tsx`, `campaigns/page.tsx`, `LeadDetail.tsx`, `pricing/page.tsx`, `crm/client.ts`, `store.ts`, `CeoDashboard.tsx`, `market-intelligence/db.ts`, `intelligence/page.tsx`, `rate-engine/types.ts`, `client-portal/types.ts`, `deal-intelligence/index.ts`, `VkIntentClient.tsx`, `TgMonitorClient.tsx`, `MarketingPageClient.tsx`, `SalesDashboard.tsx`, `multitenant/types.ts`, `reports/page.tsx`, `PlatformDashboard.tsx`, `CreateWizard.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `proposals/types.ts`, `WbSellersClient.tsx`, `HhLeadsClient.tsx`, `ai-company/page.tsx`, `ImportLead`, `market-intelligence/types.ts`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `lib/finance/types.ts`, `settings/route.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `getTenantId`, `product-finder/route.ts`, `ceo/report/route.ts`, `expenses/[id]/route.ts`, `payments/create/route.ts`, `SalesDashboard.tsx`, `vk-ads/sync/route.ts`, `getLeads`, `partners/db.ts`, `reports/page.tsx`, `check/route.ts`, `notifications/route.ts`, `finance/api.ts`, `sales/data.ts`, `ai-company/page.tsx`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `tender-intelligence/route.ts`, `ai-funnel/submit/route.ts`, `vk-ads/sync/route.ts`, `getLeads`, `api/leads/route.ts`, `import-leads/crm.ts`, `lead-finder/index.ts`, `finance/api.ts`, `economics/route.ts`?**
