# Graph Report - chinabridge  (2026-09-10)

## Corpus Check
- 776 files · ~1,030,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4457 nodes · 8321 edges · 319 communities (258 shown, 61 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f25026d`
...
2. `AdminNav()` - 59 edges
3. `createLead()` - 39 edges
4. `getDb()` - 38 edges
5. `getTenantId()` - 35 edges
6. `getSession()` - 34 edges
7. `getLLMConfig()` - 28 edges
8. `trackGAEvent()` - 26 edges
9. `Breadcrumbs()` - 25 edges
10. `getLeads()` - 23 edges

## Surprising Connections (you probably didn't know these)
- `ImportCategoryPage()` --calls--> `trackGAEvent()`  [EXTRACTED]
  app/import/[category]/page.tsx → lib/analytics/ga.ts
...
Cohesion: 0.06
Nodes (48): CHANNEL_COLORS, ContentDashboard(), PRI, Props, SOURCE_LABEL, STATUS_STYLE, TABS, TYPE_ICONS (+40 more)
...
Cohesion: 0.07
Nodes (39): dynamic, loadReport(), StrategyPage(), IMPACT_CFG, POTENTIAL_CFG, PRIORITY_CFG, Props, StrategyDashboard() (+31 more)

### Community 8 - "MarketingDashboard.tsx"
Cohesion: 0.07
Nodes (41): MarketingDashboard(), PLATFORM_STYLE, PRIORITY_STYLE, Props, STATUS_STYLE, TABS, dynamic, loadReport() (+33 more)
...
Cohesion: 0.18
Nodes (15): BillingPage(), dynamic, TenantPage(), getCurrentTenant(), isSuperAdmin(), requireSuperAdmin(), createTenant(), defaultModules() (+7 more)
...
Cohesion: 0.18
Nodes (22): dynamic, MarketIntelligencePage(), dynamic, GET(), maxDuration, dynamic, GET(), getTenantId() (+14 more)
...
Cohesion: 0.10
Nodes (23): ensureTable(), GET(), POST(), isAuthorized(), maxDuration, POST(), runtime, fallbackOffer() (+15 more)
...
### Community 34 - "proposals/create/route.ts"
Cohesion: 0.18
Nodes (13): POST(), runtime, dynamic, GET(), runtime, dynamic, GET(), runtime (+5 more)
...
Cohesion: 0.19
Nodes (21): maxDuration, POST(), runtime, saveQuestion(), runConsultant(), runAgent(), runLogistic(), runOperator() (+13 more)
...
### Community 38 - "1688-buyout/page.tsx"
Cohesion: 0.11
Nodes (13): CITIES, metadata, FAQ, metadata, schema, FAQ, metadata, schema (+5 more)

### Community 39 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
...
### Community 43 - "finance/settings/page.tsx"
Cohesion: 0.17
Nodes (13): dynamic, FinanceSettingsPage(), revalidate, dynamic, GET(), PUT(), runtime, FinanceSettingsForm() (+5 more)

### Community 44 - "reports/page.tsx"
Cohesion: 0.13
Nodes (18): FinanceDashboardPage(), dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), POST() (+10 more)
...
Cohesion: 0.10
Nodes (20): NotFound(), CITIES, Step, WhiteImportPage(), GAInner(), DirectionsSplit(), Hero(), HowItWorks() (+12 more)

### Community 47 - "crm/client.ts"
Cohesion: 0.13
Nodes (19): dynamic, isAuthorized(), POST(), runtime, scoreFromReviews(), POST(), maxDuration, POST() (+11 more)
...
Cohesion: 0.09
Nodes (25): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, detectCountry(), EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice() (+17 more)
...
### Community 53 - "generator.ts"
Cohesion: 0.18
Nodes (16): MODES, ProposalButton(), generateProposal(), generateProposalNumber(), ProposalDocument(), registerFonts(), getMissingFields(), detectServiceKey() (+8 more)
...
Cohesion: 0.14
Nodes (11): ALERT_COLORS, RISK_COLORS, DEMO_SIGNALS, Tab, TAB_DEFS, TYPE_COLOR, DealIntelligenceResult, DealScore (+3 more)
...
### Community 75 - "admin/calculations/page.tsx"
Cohesion: 0.38
...
### Community 77 - "import-leads/crm.ts"
Cohesion: 0.16
...
### Community 84 - "AdminNav.tsx"
Cohesion: 0.07
Nodes (20): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, dynamic, LeadPage(), revalidate, DealIntelligenceClient() (+12 more)
...
### Community 90 - "dev-reset/route.ts"
Cohesion: 0.67
...
Cohesion: 0.13
Nodes (14): PIPE_COLORS, SOURCE_ICON, Tab, TEMP_COLORS, buildMIComment(), dynamic, GET(), getTenantId() (+6 more)
...
Cohesion: 0.13
Nodes (11): AUDIENCE, FAQ, FEATURES, FORMATS, PROBLEMS, SAAS_PLANS, metadata, SERVICE_LINKS (+3 more)

### Community 97 - "history/route.ts"
Cohesion: 0.43
Nodes (6): dynamic, ensureTable(), GET(), getClientId(), POST(), runtime

### Community 98 - "multitenant/types.ts"
Cohesion: 0.17
Nodes (15): AI_LINKS, TenantDetail(), buildAiContext(), buildAiSystemPrompt(), buildDeptAiPrompt(), injectTenantContext(), getTenantSettings(), BillingInfo (+7 more)
...
### Community 102 - "tenants/[id]/route.ts"
Cohesion: 0.39
...
Cohesion: 0.15
Nodes (13): CATEGORIES, CITIES, ImportCategoryPage(), YandexMetrika(), Cases, Services, analytics, CATEGORY_MAP (+5 more)

### Community 107 - "sales/data.ts"
Cohesion: 0.25
...
### Community 114 - "SalesDashboard.tsx"
Cohesion: 0.09
Nodes (27): dynamic, loadReport(), metadata, SalesPage(), PRIO, Priority, SalesDashboard(), Tab (+19 more)

### Community 115 - "dtQuery"
Cohesion: 0.32
...
### Community 124 - "admin/settings/billing/page.tsx"
Cohesion: 0.17
Nodes (10): BillingClient(), Plan, PLAN_BTN, PLAN_COLOR, dynamic, dynamic, COUNTRY_FLAG, PLAN_BADGE (+2 more)

### Community 125 - "finance/api.ts"
Cohesion: 0.07
Nodes (44): dynamic, GET(), POST(), runtime, dynamic, PATCH(), runtime, dynamic (+36 more)
...
Cohesion: 0.16
Nodes (20): getAiAnalysis(), maxDuration, POST(), runtime, saveProductAnalysis(), sendTelegramAlert(), buildScenario(), calculateUnitEconomics() (+12 more)
...
### Community 143 - "CeoReportWidget.tsx"
Cohesion: 0.20
...
### Community 146 - "calculator/submit/route.ts"
Cohesion: 0.53
Nodes (5): escapeNonAscii(), handlePost(), notifyManagerTelegram(), POST(), runtime
...
### Community 150 - "LeadMagnetForm.tsx"
Cohesion: 0.22
...
### Community 157 - "tenants/route.ts"
Cohesion: 0.24
...
Cohesion: 0.20
Nodes (13): DRIP, dynamic, GET(), runtime, sendTg(), answerCallback(), dynamic, ensureBridgeTables() (+5 more)
...
### Community 169 - "supplier-finder/route.ts"
Cohesion: 0.47
...
### Community 171 - "import-electronics-from-china/page.tsx"
Cohesion: 0.33
...
### Community 174 - "Footer.tsx"
Cohesion: 0.15
Nodes (13): AUDIT_POINTS, jsonLd, metadata, generateMetadata(), getPage(), SeoPage, companyLinks, Footer() (+5 more)

### Community 175 - "TochkaLinksSection.tsx"
Cohesion: 0.38
...
### Community 191 - "PlatformDashboard.tsx"
Cohesion: 0.22
...
### Community 201 - "[id]/offer/route.ts"
Cohesion: 0.29
...
### Community 255 - "Header.tsx"
Cohesion: 0.10
Nodes (11): competitors, jsonLd, metadata, metadata, jsonLd, metadata, FAQS, metadata (+3 more)
...
### Community 264 - "CTASection.tsx"
Cohesion: 0.10
Nodes (14): FAQ, metadata, schema, FAQ, metadata, schema, FAQ, metadata (+6 more)
...
### Community 267 - "ImportAuditForm.tsx"
Cohesion: 0.40
...
### Community 269 - "check-paid/route.ts"
Cohesion: 0.67
Nodes (3): dynamic, GET(), getClientId()
...
### Community 277 - "checks/api.ts"
Cohesion: 0.40
Nodes (5): AUTH, checkApi(), fetchRoute(), ROUTES, RouteSpec

### Community 278 - "getLead"
Cohesion: 0.31
Nodes (9): DELETE(), dynamic, GET(), PATCH(), runtime, deleteLead(), getLead(), resolveTenantId() (+1 more)
...
### Community 294 - "fulfilment/page.tsx"
Cohesion: 0.25
Nodes (6): FulfilmentClient(), MARKETS, SERVICES, STEPS, WAREHOUSES, metadata

### Community 296 - "supplier-wildberries-china/page.tsx"
Cohesion: 0.33
Nodes (4): jsonLd, metadata, niches, steps

### Community 298 - "VkAdsDashboard.tsx"
Cohesion: 0.29
Nodes (5): AccountData, Campaign, LeadData, LeadForm, VkAdsDashboard()

### Community 299 - "chat/page.tsx"
Cohesion: 0.29
Nodes (5): dynamic, revalidate, Message, PROMPTS, SalesChatClient()

### Community 302 - "marketplace-rates/route.ts"
Cohesion: 0.33
Nodes (5): dynamic, PATCH(), runtime, upsertMpRate(), MARKETPLACES

### Community 303 - "import-consultant.ts"
Cohesion: 0.29
Nodes (8): AIConsultantPanel(), getInitialCTAs(), Message, Props, buildSystem(), CalcContext, DeliveryOption, runImportConsultant()

### Community 304 - "cargo-china-moscow/page.tsx"
Cohesion: 0.33
Nodes (4): FAQ, metadata, ROUTES, schema

### Community 305 - "briefing/route.ts"
Cohesion: 0.38
Nodes (6): GET(), isAuthorized(), maxDuration, OfferResult, runtime, selectOffer()

### Community 306 - "FAQSection.tsx"
Cohesion: 0.09
Nodes (16): FAQ, metadata, schema, FAQ, metadata, schema, FAQ, metadata (+8 more)

### Community 308 - "integrations/page.tsx"
Cohesion: 0.40
Nodes (3): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus

### Community 309 - "getTenantId"
Cohesion: 0.11
Nodes (24): dynamic, GET(), PATCH(), runtime, FinancePDF(), GET(), dynamic, GET() (+16 more)

### Community 310 - "rates/route.ts"
Cohesion: 0.50
Nodes (3): POST(), runtime, validateShippingRate()

### Community 312 - "registrations/page.tsx"
Cohesion: 0.47
Nodes (5): Client, COUNTRY_FLAG, daysSince(), fmt(), RegistrationsPage()

### Community 313 - "product-finder/route.ts"
Cohesion: 0.47
Nodes (5): checkLimit(), getIp(), maxDuration, POST(), runtime

### Community 314 - "cargo-consolidation/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

### Community 318 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema

## Knowledge Gaps
- **1437 isolated node(s):** `runtime`, `maxDuration`, `ExtractedPost`, `AnalyticsRow`, `CrmStats` (+1432 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `lib/finance/types.ts`, `store.ts`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `HhLeadsClient.tsx`, `LeadDetail.tsx`, `pricing/page.tsx`, `campaigns/page.tsx`, `CeoDashboard.tsx`, `SalesCompaniesClient.tsx`, `market-intelligence/db.ts`, `intelligence/page.tsx`, `proposals/page.tsx`, `rate-engine/types.ts`, `tenders/page.tsx`, `VkIntentClient.tsx`, `VkAdsDashboard.tsx`, `finance/settings/page.tsx`, `reports/page.tsx`, `chat/page.tsx`, `MarketingPageClient.tsx`, `integrations/page.tsx`, `registrations/page.tsx`, `PlatformDashboard.tsx`, `TgMonitorClient.tsx`, `CreateWizard.tsx`, `admin/calculations/page.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `WbSellersClient.tsx`, `ai-company/page.tsx`, `SalesDashboard.tsx`, `ImportLead`, `admin/settings/billing/page.tsx`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `economics/route.ts`, `tender-intelligence/route.ts`, `calculator.ts`, `import-leads/crm.ts`, `calculator/submit/route.ts`, `vk-ads/sync/route.ts`, `getTenantId`, `getLead`, `api/leads/route.ts`, `finance/api.ts`, `market-intelligence/leads/route.ts`, `memory.ts`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `analytics/data.ts`, `lib/finance/types.ts`, `OperationsDashboard.tsx`, `client-portal/api.ts`, `ceo/report/route.ts`, `vk-ads/sync/route.ts`, `notifications/route.ts`, `vk-ads/campaigns/route.ts`, `supplier-finder/route.ts`, `finance/settings/page.tsx`, `reports/page.tsx`, `getTenantId`, `product-finder/route.ts`, `partners/db.ts`, `setup/route.ts`, `ai-company/page.tsx`, `sales/data.ts`, `SalesDashboard.tsx`, `check/route.ts`, `finance/api.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `runtime`, `maxDuration`, `ExtractedPost` to the rest of the system?**
