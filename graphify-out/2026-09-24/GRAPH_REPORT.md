...
Cohesion: 0.08
Nodes (35): dynamic, MODE_COLORS, ProposalsPage(), revalidate, STATUS_COLORS, STATUS_LABELS, POST(), runtime (+27 more)
...
### Community 86 - "admin/settings/billing/page.tsx"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (5): AuditResult, Insight, MARKETPLACE_LABEL, STEPS, metadata
...
Cohesion: 0.30
Nodes (11): Props, CheckRow(), CtoDashboard(), FixResult, fmtDate(), scoreBg(), scoreColor(), SectionCard() (+3 more)
...
Cohesion: 0.13
Nodes (18): dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), POST(), runtime (+10 more)
...
### Community 130 - "cashflow/route.ts"
Cohesion: 0.27
...
### Community 135 - "CalcLeftPanel.tsx"
Cohesion: 0.28
...
### Community 137 - "payments/route.ts"
Cohesion: 0.36
...
### Community 143 - "multitenant/types.ts"
Cohesion: 0.12
Nodes (20): COUNTRY_FLAG, fmtMoney(), PLAN_BADGE, PlatformDashboard(), STATUS_DOT, COUNTRY_FLAG, PLAN_BADGE, buildAiContext() (+12 more)
...
### Community 160 - "preview/route.ts"
Cohesion: 0.36
...
### Community 175 - "registrations/page.tsx"
Cohesion: 0.47
Nodes (5): Client, COUNTRY_FLAG, daysSince(), fmt(), RegistrationsPage()

### Community 176 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
Nodes (7): GET(), getToken(), maxDuration, POST(), runtime, vkGet(), vkPost()

### Community 177 - "store.ts"
Cohesion: 0.13
Nodes (21): GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration, POST(), runtime (+13 more)
...
### Community 201 - "supplier-finder/route.ts"
Cohesion: 0.47
...
Cohesion: 0.13
Nodes (22): getAiAnalysis(), maxDuration, POST(), runtime, saveProductAnalysis(), sendTelegramAlert(), buildScenario(), calculateUnitEconomics() (+14 more)
...
### Community 314 - "tenants/[id]/route.ts"
Cohesion: 0.39
...
### Community 329 - "marketplace-rates/route.ts"
Cohesion: 0.33
...
### Community 339 - "payments/[id]/route.ts"
Cohesion: 0.50
...
### Community 351 - "fix-delivery-days-pg.mjs"
Cohesion: 0.50
Nodes (3): envContent, envPath, sql
