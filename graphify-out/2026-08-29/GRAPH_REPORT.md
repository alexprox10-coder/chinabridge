# Graph Report - chinabridge  (2026-08-29)

## Corpus Check
- 726 files · ~1,000,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4210 nodes · 7963 edges · 277 communities (226 shown, 51 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ec9cf25`
...
### Community 10 - "Footer.tsx"
Cohesion: 0.07
Nodes (27): metadata, FulfilmentClient(), MARKETS, SERVICES, STEPS, WAREHOUSES, metadata, jsonLd (+19 more)
...
Cohesion: 0.14
Nodes (16): ALL_STATUSES, COLUMNS, LeadCard(), msAgo(), timeLabel(), AiSummary, ALL_PRIORITIES, ALL_STATUSES (+8 more)
...
Cohesion: 0.05
Nodes (49): dynamic, GET(), runtime, dynamic, PATCH(), runtime, dynamic, GET() (+41 more)

### Community 22 - "store.ts"
Cohesion: 0.13
Nodes (23): GET(), maxDuration, runtime, GET(), isSuperAdmin(), maxDuration, POST(), runtime (+15 more)

### Community 23 - "getTenantId"
Cohesion: 0.09
Nodes (32): FinanceDashboardPage(), dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), POST() (+24 more)
...
Cohesion: 0.16
Nodes (16): dynamic, GET(), maxDuration, GET(), isAuthorized(), POST(), runtime, buildImportComment() (+8 more)
...
### Community 43 - "getLeads"
Cohesion: 0.16
Nodes (14): DashboardPage(), dynamic, revalidate, auth(), ensureTable(), GET(), POST(), DELETE() (+6 more)

### Community 44 - "pricing-engine.ts"
Cohesion: 0.17
...
Cohesion: 0.07
Nodes (12): metadata, schemaOrg, Advantages, Directions, DirectionsSplit(), faqs, CARDS, COMPARISON_ROWS (+4 more)
...
Cohesion: 0.07
Nodes (38): dynamic, MODE_COLORS, ProposalsPage(), revalidate, STATUS_COLORS, STATUS_LABELS, POST(), runtime (+30 more)
...
### Community 66 - "vk-ads/sync/route.ts"
Cohesion: 0.24
...
### Community 71 - "payments/route.ts"
Cohesion: 0.36
...
### Community 77 - "DealIntelligenceClient.tsx"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (47): FinanceSettingsPage(), dynamic, GET(), POST(), runtime, dynamic, FinancePDF(), GET() (+39 more)

### Community 91 - "outreach-leads/page.tsx"
Cohesion: 0.05
Nodes (34): dynamic, LogItem, RunResult, Tab, TG_TARGETS, TgMonitorClient(), VK_TARGETS, dynamic (+26 more)
...
### Community 94 - "CeoReportWidget.tsx"
Cohesion: 0.20
...
### Community 97 - "b2bchina-alternative/page.tsx"
Cohesion: 0.40
Nodes (3): competitors, jsonLd, metadata

### Community 98 - "marketing/partners/page.tsx"
Cohesion: 0.33
...
### Community 104 - "registrations/page.tsx"
Cohesion: 0.47
...
### Community 106 - "sales/tasks/route.ts"
Cohesion: 0.47
...
### Community 115 - "knowledge/chat/route.ts"
Cohesion: 0.40
...
### Community 124 - "supplier-finder/route.ts"
Cohesion: 0.47
Nodes (5): checkLimit(), getIp(), maxDuration, POST(), runtime

### Community 125 - "multitenant/types.ts"
Cohesion: 0.12
...
Cohesion: 0.26
Nodes (14): GET(), maxDuration, runtime, ensureLinksTable(), POST(), runtime, sql, updateTenant() (+6 more)
...
Cohesion: 0.25
Nodes (14): POST(), runtime, deleteLeadPermanently(), dtInsert(), dtQuery(), isDuplicateWebsite(), saveLead(), ensureTable() (+6 more)
...
### Community 146 - "tenants/[id]/page.tsx"
Cohesion: 0.33
Nodes (5): dynamic, TenantPage(), AI_LINKS, TenantDetail(), PLAN_CONFIG

### Community 147 - "LeadMagnetForm.tsx"
Cohesion: 0.10
Nodes (13): benefits, faqs, jsonLd, metadata, inter, metadata, orgSchema, trackVkGoal() (+5 more)
...
### Community 151 - "china-blagoveshchensk/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
Cohesion: 0.09
Nodes (24): GAInner(), YandexMetrika(), Cases, checks, Hero(), HowItWorks(), STEPS, ImportEcosystemBlock() (+16 more)
...
### Community 162 - "campaigns/page.tsx"
Cohesion: 0.28
Nodes (8): buildUtm(), Campaign, CampaignsPage(), CHANNEL_ICONS, CHANNELS, slugify(), STATUS_COLORS, STATUS_LABELS

### Community 163 - "tenders/page.tsx"
Cohesion: 0.28
Nodes (7): DetailModal(), PRIORITY_COLOR, rub(), Stats, STATUS_COLOR, TenderDashboard(), TenderOp
...
### Community 168 - "briefing/route.ts"
Cohesion: 0.38
Nodes (6): GET(), isAuthorized(), maxDuration, OfferResult, runtime, selectOffer()

### Community 169 - "ai-sales-agent/route.ts"
Cohesion: 0.36
...
### Community 171 - "VkAdsDashboard.tsx"
Cohesion: 0.15
Nodes (8): IntegrationsClient(), STATIC_INTEGRATIONS, VkStatus, AccountData, Campaign, LeadData, LeadForm, VkAdsDashboard()
...
### Community 180 - "crm/client.ts"
Cohesion: 0.08
Nodes (34): dynamic, LeadPage(), revalidate, dynamic, isAuthorized(), POST(), runtime, scoreFromReviews() (+26 more)
...
### Community 230 - "china-spb/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 256 - "vk-ads/campaigns/route.ts"
Cohesion: 0.43
...
### Community 262 - "AdminNav.tsx"
Cohesion: 0.06
Nodes (42): dynamic, Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, dynamic, FinanceExpensesPage(), fmtDate() (+34 more)

### Community 263 - "currency/route.ts"
Cohesion: 0.33
Nodes (6): CbrValute, fetchCbrRates(), GET(), RatesResult, revalidate, runtime

### Community 264 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 281 - "wb-leads/route.ts"
Cohesion: 0.60
Nodes (4): GET(), isAuthorized(), POST(), runtime

## Knowledge Gaps
- **1343 isolated node(s):** `ExtractedPost`, `AnalyticsRow`, `CrmStats`, `DemoChannel`, `Period` (+1338 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `ContentPageClient.tsx`, `SeoClustersClient.tsx`, `AiOsDashboard.tsx`, `tenants/[id]/page.tsx`, `LeadDetail.tsx`, `pricing/page.tsx`, `PlatformDashboard.tsx`, `getTenantId`, `intelligence/page.tsx`, `rate-engine/types.ts`, `campaigns/page.tsx`, `tenders/page.tsx`, `client-portal/types.ts`, `getLeads`, `VkAdsDashboard.tsx`, `sales/data.ts`, `MarketingPageClient.tsx`, `chat/page.tsx`, `crm/client.ts`, `generator.ts`, `CreateWizard.tsx`, `deal-intelligence/index.ts`, `market-intelligence/types.ts`, `DealIntelligenceClient.tsx`, `admin/settings/billing/page.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `outreach-leads/page.tsx`, `marketing/partners/page.tsx`, `WbSellersClient.tsx`, `registrations/page.tsx`, `HhLeadsClient.tsx`, `ImportLead`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `vk-ads/campaigns/route.ts`, `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `client-portal/api.ts`, `check/route.ts`, `setup/route.ts`, `ceo/report/route.ts`, `AiOsDashboard.tsx`, `getTenantId`, `getLeads`, `sales/data.ts`, `partners/db.ts`, `vk-ads/sync/route.ts`, `payments/route.ts`, `payments/create/route.ts`, `notifications/route.ts`, `finance/api.ts`, `supplier-finder/route.ts`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `partner-portal/api.ts`, `vk-ads/sync/route.ts`, `tender-intelligence/route.ts`, `finance/api.ts`, `getAllLeads`, `getLeads`, `pricing-engine.ts`, `ai-funnel/submit/route.ts`, `api/leads/route.ts`, `market-intelligence/db.ts`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **What connects `ExtractedPost`, `AnalyticsRow`, `CrmStats` to the rest of the system?**
