# Graph Report - chinabridge  (2026-08-20)

## Corpus Check
- 653 files · ~943,537 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3794 nodes · 7207 edges · 259 communities (218 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b6f81d3`
...
Cohesion: 0.05
Nodes (31): Question, GROUP_COLOR, KwRow, TRAFFIC_COLOR, dynamic, LeadPage(), revalidate, buildUtm() (+23 more)

### Community 10 - "trackGAEvent"
Cohesion: 0.13
Nodes (13): DirectionsSplit(), checks, Hero(), HowItWorks(), STEPS, ImportEcosystemBlock(), partnerCards, stages (+5 more)
...
Cohesion: 0.06
Nodes (38): dynamic, GET(), runtime, dynamic, GET(), runtime, dynamic, GET() (+30 more)
...
Cohesion: 0.19
Nodes (15): POST(), runtime, POST(), runtime, maxDuration, POST(), runtime, createSessionToken() (+7 more)

### Community 26 - "DealIntelligenceClient.tsx"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (14): DocumentsPage(), CITIES, CreateOrderForm(), getClientDocuments(), ClientDocument, ClientOrder, DOC_TYPE_LABELS, DocumentType (+6 more)

### Community 38 - "CTASection.tsx"
Cohesion: 0.10
Nodes (18): CITIES, metadata, FAQ, metadata, schema, FAQ, metadata, schema (+10 more)

### Community 39 - "SalesDashboard.tsx"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (8): metadata, schemaOrg, Advantages, Directions, faqs, CARDS, TOPICS, FACTS

### Community 50 - "AIEconomicsFunnel.tsx"
Cohesion: 0.12
Nodes (18): AIEconomicsFunnel(), ANALYZE_STAGES, CITY_CHIPS, CorrectionData, EMPTY_CORRECTION, EMPTY_PRODUCT, estimateSalePrice(), ExtractedProduct (+10 more)

### Community 51 - "CeoReportWidget.tsx"
Cohesion: 0.20
...
Cohesion: 0.23
Nodes (14): GET(), runtime, setSessionCookie(), POST(), runtime, POST(), runtime, createClient() (+6 more)
...
Cohesion: 0.22
Nodes (15): GET(), runtime, GET(), runtime, DashboardPage(), OrdersPage(), CURRENCY_SYMBOLS, formatAmount() (+7 more)
...
### Community 71 - "finance/orders/route.ts"
Cohesion: 0.15
Nodes (17): dynamic, GET(), PATCH(), runtime, FinancePDF(), GET(), dynamic, GET() (+9 more)
...
Cohesion: 0.16
Nodes (21): GET(), maxDuration, runtime, ensureLinksTable(), POST(), runtime, sql, DELETE() (+13 more)

### Community 75 - "generator.ts"
Cohesion: 0.15
Nodes (18): MODES, ProposalButton(), generateProposal(), generateProposalNumber(), ProposalDocument(), registerFonts(), getMissingFields(), detectServiceKey() (+10 more)
...
### Community 79 - "getLeads"
Cohesion: 0.17
Nodes (19): DashboardPage(), auth(), ensureTable(), GET(), POST(), GET(), dynamic, GET() (+11 more)
...
### Community 84 - "market-intelligence/leads/route.ts"
Cohesion: 0.18
...
### Community 91 - "ai-funnel/submit/route.ts"
Cohesion: 0.43
...
### Community 93 - "isAdminOnly"
Cohesion: 0.40
Nodes (5): dynamic, POST(), runtime, WORKFLOWS, isAdminOnly()

### Community 94 - "marketplaces.ts"
Cohesion: 0.31
...
### Community 96 - "client/dashboard/page.tsx"
Cohesion: 0.22
Nodes (5): OnboardingSteps(), Props, Step, STEPS, countUnreadMessages()
...
Cohesion: 0.18
Nodes (8): benefits, faqs, jsonLd, metadata, COUNTRIES, FormState, LeadMagnetForm(), VOLUMES
...
### Community 104 - "proposals/page.tsx"
Cohesion: 0.14
...
### Community 114 - "analytics/index.ts"
Cohesion: 0.23
...
### Community 122 - "admin/settings/billing/page.tsx"
Cohesion: 0.31
...
### Community 130 - "payments/[id]/route.ts"
Cohesion: 0.50
...
### Community 135 - "china-blagoveshchensk/page.tsx"
Cohesion: 0.40
...
### Community 138 - "finance/api.ts"
Cohesion: 0.09
Nodes (30): dynamic, GET(), POST(), runtime, dynamic, PATCH(), runtime, dynamic (+22 more)
...
Cohesion: 0.20
Nodes (7): jsonLd, metadata, companyLinks, importLinks, navLinks, pageLinks, toolLinks
...
Cohesion: 0.22
Nodes (6): inter, metadata, AnalyticsProvider(), ChatWidget, ChatWidgetLoader(), ChatWindow()

### Community 148 - "seed/route.ts"
Cohesion: 0.33
...
### Community 152 - "supplier-search/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
### Community 157 - "client/profile/route.ts"
Cohesion: 0.53
Nodes (5): GET(), PATCH(), runtime, getClientById(), updateClientProfile()
...
### Community 169 - "AnalyticsProvider.tsx"
Cohesion: 0.31
Nodes (6): GoogleAnalytics(), MicrosoftClarity(), YandexMetrika(), METRIKA_ID, trackMetrikaPageView(), Window
...
### Community 180 - "reports/page.tsx"
Cohesion: 0.19
Nodes (11): FinanceDashboardPage(), dynamic, EMPTY_REPORT, FinanceReportsPage(), revalidate, dynamic, GET(), runtime (+3 more)
...
### Community 187 - "knowledge/chat/route.ts"
Cohesion: 0.40
...
### Community 191 - "getAllPayments"
Cohesion: 0.31
Nodes (8): dynamic, GET(), POST(), runtime, createPayment(), getAllPayments(), getPaymentsByLead(), rowToPayment()
...
### Community 194 - "fulfilment/page.tsx"
Cohesion: 0.25
...
### Community 230 - "import-leads/leads/route.ts"
Cohesion: 0.48
...
### Community 251 - "tenants/[id]/page.tsx"
Cohesion: 0.33
Nodes (5): dynamic, TenantPage(), AI_LINKS, TenantDetail(), PLAN_CONFIG

### Community 252 - "import-leads/run/route.ts"
Cohesion: 0.38
...
### Community 255 - "hh-leads/route.ts"
Cohesion: 0.60
Nodes (4): GET(), isAuthorized(), POST(), runtime

### Community 256 - "china-moscow/page.tsx"
Cohesion: 0.40
Nodes (3): FAQ, metadata, schema
...
## Knowledge Gaps
- **1231 isolated node(s):** `graphify`, `PRIMARY OBJECTIVE`, `MINDSET`, `DATA RULES`, `CODE RULES` (+1226 more)
...
- **Why does `AdminNav()` connect `AdminNav.tsx` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `ContentPageClient.tsx`, `admin/calculations/page.tsx`, `LeadDetail.tsx`, `multitenant/types.ts`, `lib/finance/types.ts`, `CeoDashboard.tsx`, `DealIntelligenceClient.tsx`, `intelligence/page.tsx`, `rate-engine/types.ts`, `SalesDashboard.tsx`, `market-intelligence/db.ts`, `PlatformDashboard.tsx`, `finance/settings/page.tsx`, `MarketingPageClient.tsx`, `reports/page.tsx`, `ImportLead`, `market-intelligence/types.ts`, `pricing/page.tsx`, `ai-company/page.tsx`, `SeoClustersClient.tsx`, `CreateWizard.tsx`, `ai-cto/db.ts`, `SalesDashboardClient.tsx`, `WbSellersClient.tsx`, `outreach-leads/page.tsx`, `SalesCompaniesClient.tsx`, `proposals/page.tsx`, `admin/messages/page.tsx`, `HhLeadsClient.tsx`, `chat/page.tsx`, `admin/settings/billing/page.tsx`, `tenants/[id]/page.tsx`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `isAuthorized()` connect `isAuthorized` to `FinanceDashboard.tsx`, `content/data.ts`, `analytics/data.ts`, `OperationsDashboard.tsx`, `strategy/data.ts`, `MarketingDashboard.tsx`, `vk-ads/campaigns/route.ts`, `ceo/report/route.ts`, `sales/data.ts`, `notifications/route.ts`, `client-portal/api.ts`, `import-leads/crm.ts`, `SalesDashboard.tsx`, `product-finder/route.ts`, `supplier-finder/route.ts`, `partners/db.ts`, `ai-company/page.tsx`, `finance/orders/route.ts`, `payments/create/route.ts`, `check/route.ts`, `getLeads`, `setup/route.ts`, `vk-ads/sync/route.ts`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `createLead()` connect `crm/client.ts` to `vk-ads/sync/route.ts`, `partner-portal/api.ts`, `import-leads/crm.ts`, `import-leads/leads/route.ts`, `economics/route.ts`, `market-intelligence/leads/route.ts`, `api/leads/route.ts`, `ai-funnel/submit/route.ts`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **What connects `graphify`, `PRIMARY OBJECTIVE`, `MINDSET` to the rest of the system?**
